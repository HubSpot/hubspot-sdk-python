...
class TestSubscriberState:
    ...
    def test_method_record_by_email(self, client: Hubspot, respx_mock: MockRouter) -> None:
        ...
        subscriber_state = client.marketing.events.subscriber_state.record_by_email(
    ...
    def test_raw_response_record_by_email(self, client: Hubspot, respx_mock: MockRouter) -> None:
        ...
        subscriber_state = client.marketing.events.subscriber_state.with_raw_response.record_by_email(
            subscriber_state="subscriberState",
            external_event_id="externalEventId",
            external_account_id="externalAccountId",
            inputs=[
    ...
    def test_streaming_response_record_by_email(self, client: Hubspot, respx_mock: MockRouter) -> None:
        ...
        with client.marketing.events.subscriber_state.with_streaming_response.record_by_email(
            subscriber_state="subscriberState",
            external_event_id="externalEventId",
            external_account_id="externalAccountId",
            inputs=[
    ...
    def test_path_params_record_by_email(self, client: Hubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `external_event_id` but received ''"):
            client.marketing.events.subscriber_state.with_raw_response.record_by_email(
                subscriber_state="subscriberState",
                external_event_id="",
                external_account_id="externalAccountId",
                inputs=[
    ...
    def test_method_record_by_id(self, client: Hubspot, respx_mock: MockRouter) -> None:
        ...
        subscriber_state = client.marketing.events.subscriber_state.record_by_id(
            subscriber_state="subscriberState",
            external_event_id="externalEventId",
            external_account_id="externalAccountId",
            inputs=[
    ...
    def test_raw_response_record_by_id(self, client: Hubspot, respx_mock: MockRouter) -> None:
        ...
        subscriber_state = client.marketing.events.subscriber_state.with_raw_response.record_by_id(
            subscriber_state="subscriberState",
            external_event_id="externalEventId",
            external_account_id="externalAccountId",
            inputs=[
    ...
    def test_streaming_response_record_by_id(self, client: Hubspot, respx_mock: MockRouter) -> None:
        ...
        with client.marketing.events.subscriber_state.with_streaming_response.record_by_id(
            subscriber_state="subscriberState",
            external_event_id="externalEventId",
            external_account_id="externalAccountId",
            inputs=[
    ...
    def test_path_params_record_by_id(self, client: Hubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `external_event_id` but received ''"):
            client.marketing.events.subscriber_state.with_raw_response.record_by_id(
                subscriber_state="subscriberState",
                external_event_id="",
                external_account_id="externalAccountId",
                inputs=[
...
class TestAsyncSubscriberState:
    ...
    async def test_method_record_by_email(self, async_client: AsyncHubspot, respx_mock: MockRouter) -> None:
        ...
        subscriber_state = await async_client.marketing.events.subscriber_state.record_by_email(
            subscriber_state="subscriberState",
            external_event_id="externalEventId",
            external_account_id="externalAccountId",
            inputs=[
    ...
    async def test_raw_response_record_by_email(self, async_client: AsyncHubspot, respx_mock: MockRouter) -> None:
        ...
        subscriber_state = await async_client.marketing.events.subscriber_state.with_raw_response.record_by_email(
            subscriber_state="subscriberState",
            external_event_id="externalEventId",
            external_account_id="externalAccountId",
            inputs=[
    ...
    async def test_streaming_response_record_by_email(self, async_client: AsyncHubspot, respx_mock: MockRouter) -> None:
        ...
        async with async_client.marketing.events.subscriber_state.with_streaming_response.record_by_email(
            subscriber_state="subscriberState",
            external_event_id="externalEventId",
            external_account_id="externalAccountId",
            inputs=[
    ...
    async def test_path_params_record_by_email(self, async_client: AsyncHubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `external_event_id` but received ''"):
            await async_client.marketing.events.subscriber_state.with_raw_response.record_by_email(
                subscriber_state="subscriberState",
                external_event_id="",
                external_account_id="externalAccountId",
                inputs=[
    ...
    async def test_method_record_by_id(self, async_client: AsyncHubspot, respx_mock: MockRouter) -> None:
        ...
        subscriber_state = await async_client.marketing.events.subscriber_state.record_by_id(
            subscriber_state="subscriberState",
            external_event_id="externalEventId",
            external_account_id="externalAccountId",
            inputs=[
    ...
    async def test_raw_response_record_by_id(self, async_client: AsyncHubspot, respx_mock: MockRouter) -> None:
        ...
        subscriber_state = await async_client.marketing.events.subscriber_state.with_raw_response.record_by_id(
            subscriber_state="subscriberState",
            external_event_id="externalEventId",
            external_account_id="externalAccountId",
            inputs=[
    ...
    async def test_streaming_response_record_by_id(self, async_client: AsyncHubspot, respx_mock: MockRouter) -> None:
        ...
        async with async_client.marketing.events.subscriber_state.with_streaming_response.record_by_id(
            subscriber_state="subscriberState",
            external_event_id="externalEventId",
            external_account_id="externalAccountId",
            inputs=[
    ...
    async def test_path_params_record_by_id(self, async_client: AsyncHubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `external_event_id` but received ''"):
            await async_client.marketing.events.subscriber_state.with_raw_response.record_by_id(
                subscriber_state="subscriberState",
                external_event_id="",
                external_account_id="externalAccountId",
                inputs=[
