...
class TestTransactional:
    ...
    def test_method_send(self, client: Hubspot) -> None:
        transactional = client.marketing.transactional.send(
        ...
        assert_matches_type(EmailSendStatusView, transactional, path=["response"])
    ...
    def test_raw_response_send(self, client: Hubspot) -> None:
        response = client.marketing.transactional.with_raw_response.send(
            contact_properties={"foo": "string"},
            custom_properties={"foo": {}},
            email_id=0,
            message={
    ...
    def test_streaming_response_send(self, client: Hubspot) -> None:
        with client.marketing.transactional.with_streaming_response.send(
            contact_properties={"foo": "string"},
            custom_properties={"foo": {}},
            email_id=0,
            message={
...
class TestAsyncTransactional:
    ...
    async def test_method_send(self, async_client: AsyncHubspot) -> None:
        transactional = await async_client.marketing.transactional.send(
            contact_properties={"foo": "string"},
            custom_properties={"foo": {}},
            email_id=0,
            message={
    ...
    async def test_raw_response_send(self, async_client: AsyncHubspot) -> None:
        response = await async_client.marketing.transactional.with_raw_response.send(
            contact_properties={"foo": "string"},
            custom_properties={"foo": {}},
            email_id=0,
            message={
    ...
    async def test_streaming_response_send(self, async_client: AsyncHubspot) -> None:
        async with async_client.marketing.transactional.with_streaming_response.send(
            contact_properties={"foo": "string"},
            custom_properties={"foo": {}},
            email_id=0,
            message={
