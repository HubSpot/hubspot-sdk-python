...
class TestRows:
    ...
    def test_method_clone_batch(self, client: HubSpot) -> None:
        row = client.cms.hubdb.rows.clone_batch(
            table_id_or_name="tableIdOrName",
            inputs=[{"id": "id"}],
        )
    ...
    def test_raw_response_clone_batch(self, client: HubSpot) -> None:
        response = client.cms.hubdb.rows.with_raw_response.clone_batch(
            table_id_or_name="tableIdOrName",
            inputs=[{"id": "id"}],
        )
    ...
    def test_streaming_response_clone_batch(self, client: HubSpot) -> None:
        with client.cms.hubdb.rows.with_streaming_response.clone_batch(
            table_id_or_name="tableIdOrName",
            inputs=[{"id": "id"}],
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_clone_batch(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            client.cms.hubdb.rows.with_raw_response.clone_batch(
                table_id_or_name="",
                inputs=[{"id": "id"}],
            )
    ...
    def test_method_create_batch(self, client: HubSpot) -> None:
        row = client.cms.hubdb.rows.create_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    def test_raw_response_create_batch(self, client: HubSpot) -> None:
        response = client.cms.hubdb.rows.with_raw_response.create_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    def test_streaming_response_create_batch(self, client: HubSpot) -> None:
        with client.cms.hubdb.rows.with_streaming_response.create_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    def test_path_params_create_batch(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            client.cms.hubdb.rows.with_raw_response.create_batch(
                table_id_or_name="",
                inputs=[
                    {
                        "child_table_id": 0,
    ...
    def test_method_get_batch(self, client: HubSpot) -> None:
        row = client.cms.hubdb.rows.get_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        )
        assert_matches_type(BatchResponseHubDBTableRowV3, row, path=["response"])
    ...
    def test_raw_response_get_batch(self, client: HubSpot) -> None:
        response = client.cms.hubdb.rows.with_raw_response.get_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        )
    ...
    def test_streaming_response_get_batch(self, client: HubSpot) -> None:
        with client.cms.hubdb.rows.with_streaming_response.get_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get_batch(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            client.cms.hubdb.rows.with_raw_response.get_batch(
                table_id_or_name="",
                inputs=["string"],
            )
    ...
    def test_method_get_draft_batch(self, client: HubSpot) -> None:
        row = client.cms.hubdb.rows.get_draft_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        )
        assert_matches_type(BatchResponseHubDBTableRowV3, row, path=["response"])
    ...
    def test_raw_response_get_draft_batch(self, client: HubSpot) -> None:
        response = client.cms.hubdb.rows.with_raw_response.get_draft_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        )
    ...
    def test_streaming_response_get_draft_batch(self, client: HubSpot) -> None:
        with client.cms.hubdb.rows.with_streaming_response.get_draft_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get_draft_batch(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            client.cms.hubdb.rows.with_raw_response.get_draft_batch(
                table_id_or_name="",
                inputs=["string"],
            )
    ...
    def test_method_purge_batch(self, client: HubSpot) -> None:
        row = client.cms.hubdb.rows.purge_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        )
        assert row is None
    ...
    def test_raw_response_purge_batch(self, client: HubSpot) -> None:
        response = client.cms.hubdb.rows.with_raw_response.purge_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        )
    ...
    def test_streaming_response_purge_batch(self, client: HubSpot) -> None:
        with client.cms.hubdb.rows.with_streaming_response.purge_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_purge_batch(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            client.cms.hubdb.rows.with_raw_response.purge_batch(
                table_id_or_name="",
                inputs=["string"],
            )
    ...
    def test_method_replace_batch(self, client: HubSpot) -> None:
        row = client.cms.hubdb.rows.replace_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    def test_raw_response_replace_batch(self, client: HubSpot) -> None:
        response = client.cms.hubdb.rows.with_raw_response.replace_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    def test_streaming_response_replace_batch(self, client: HubSpot) -> None:
        with client.cms.hubdb.rows.with_streaming_response.replace_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    def test_path_params_replace_batch(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            client.cms.hubdb.rows.with_raw_response.replace_batch(
                table_id_or_name="",
                inputs=[
                    {
                        "child_table_id": 0,
    ...
    def test_method_update_batch(self, client: HubSpot) -> None:
        row = client.cms.hubdb.rows.update_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    def test_raw_response_update_batch(self, client: HubSpot) -> None:
        response = client.cms.hubdb.rows.with_raw_response.update_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    def test_streaming_response_update_batch(self, client: HubSpot) -> None:
        with client.cms.hubdb.rows.with_streaming_response.update_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    def test_path_params_update_batch(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            client.cms.hubdb.rows.with_raw_response.update_batch(
                table_id_or_name="",
                inputs=[
                    {
                        "child_table_id": 0,
...
class TestAsyncRows:
    ...
    async def test_method_clone_batch(self, async_client: AsyncHubSpot) -> None:
        row = await async_client.cms.hubdb.rows.clone_batch(
            table_id_or_name="tableIdOrName",
            inputs=[{"id": "id"}],
        )
        assert_matches_type(BatchResponseHubDBTableRowV3, row, path=["response"])
    ...
    async def test_raw_response_clone_batch(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.hubdb.rows.with_raw_response.clone_batch(
            table_id_or_name="tableIdOrName",
            inputs=[{"id": "id"}],
        )
    ...
    async def test_streaming_response_clone_batch(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.hubdb.rows.with_streaming_response.clone_batch(
            table_id_or_name="tableIdOrName",
            inputs=[{"id": "id"}],
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_clone_batch(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            await async_client.cms.hubdb.rows.with_raw_response.clone_batch(
                table_id_or_name="",
                inputs=[{"id": "id"}],
            )
    ...
    async def test_method_create_batch(self, async_client: AsyncHubSpot) -> None:
        row = await async_client.cms.hubdb.rows.create_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    async def test_raw_response_create_batch(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.hubdb.rows.with_raw_response.create_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    async def test_streaming_response_create_batch(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.hubdb.rows.with_streaming_response.create_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    async def test_path_params_create_batch(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            await async_client.cms.hubdb.rows.with_raw_response.create_batch(
                table_id_or_name="",
                inputs=[
                    {
                        "child_table_id": 0,
    ...
    async def test_method_get_batch(self, async_client: AsyncHubSpot) -> None:
        row = await async_client.cms.hubdb.rows.get_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        )
        assert_matches_type(BatchResponseHubDBTableRowV3, row, path=["response"])
    ...
    async def test_raw_response_get_batch(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.hubdb.rows.with_raw_response.get_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        )
    ...
    async def test_streaming_response_get_batch(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.hubdb.rows.with_streaming_response.get_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_batch(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            await async_client.cms.hubdb.rows.with_raw_response.get_batch(
                table_id_or_name="",
                inputs=["string"],
            )
    ...
    async def test_method_get_draft_batch(self, async_client: AsyncHubSpot) -> None:
        row = await async_client.cms.hubdb.rows.get_draft_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        )
        assert_matches_type(BatchResponseHubDBTableRowV3, row, path=["response"])
    ...
    async def test_raw_response_get_draft_batch(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.hubdb.rows.with_raw_response.get_draft_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        )
    ...
    async def test_streaming_response_get_draft_batch(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.hubdb.rows.with_streaming_response.get_draft_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_draft_batch(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            await async_client.cms.hubdb.rows.with_raw_response.get_draft_batch(
                table_id_or_name="",
                inputs=["string"],
            )
    ...
    async def test_method_purge_batch(self, async_client: AsyncHubSpot) -> None:
        row = await async_client.cms.hubdb.rows.purge_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        )
        assert row is None
    ...
    async def test_raw_response_purge_batch(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.hubdb.rows.with_raw_response.purge_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        )
    ...
    async def test_streaming_response_purge_batch(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.hubdb.rows.with_streaming_response.purge_batch(
            table_id_or_name="tableIdOrName",
            inputs=["string"],
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_purge_batch(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            await async_client.cms.hubdb.rows.with_raw_response.purge_batch(
                table_id_or_name="",
                inputs=["string"],
            )
    ...
    async def test_method_replace_batch(self, async_client: AsyncHubSpot) -> None:
        row = await async_client.cms.hubdb.rows.replace_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    async def test_raw_response_replace_batch(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.hubdb.rows.with_raw_response.replace_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    async def test_streaming_response_replace_batch(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.hubdb.rows.with_streaming_response.replace_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    async def test_path_params_replace_batch(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            await async_client.cms.hubdb.rows.with_raw_response.replace_batch(
                table_id_or_name="",
                inputs=[
                    {
                        "child_table_id": 0,
    ...
    async def test_method_update_batch(self, async_client: AsyncHubSpot) -> None:
        row = await async_client.cms.hubdb.rows.update_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    async def test_raw_response_update_batch(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.hubdb.rows.with_raw_response.update_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    async def test_streaming_response_update_batch(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.hubdb.rows.with_streaming_response.update_batch(
            table_id_or_name="tableIdOrName",
            inputs=[
                {
                    "child_table_id": 0,
    ...
    async def test_path_params_update_batch(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `table_id_or_name` but received ''"):
            await async_client.cms.hubdb.rows.with_raw_response.update_batch(
                table_id_or_name="",
                inputs=[
                    {
                        "child_table_id": 0,
