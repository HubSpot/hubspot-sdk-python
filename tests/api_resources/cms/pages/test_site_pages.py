...
class TestSitePages:
    ...
    def test_method_create(self, client: HubSpot) -> None:
        ...
        assert_matches_type(PagesPage, site_page, path=["response"])
    ...
    def test_method_list(self, client: HubSpot) -> None:
        ...
        assert_matches_type(SyncPage[PagesPage], site_page, path=["response"])
...
class TestAsyncSitePages:
    ...
    async def test_method_list(self, async_client: AsyncHubSpot) -> None:
        ...
        assert_matches_type(AsyncPage[PagesPage], site_page, path=["response"])
