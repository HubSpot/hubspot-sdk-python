...
class TestWebsitePages:
    ...
    def test_method_create(self, client: Hubspot) -> None:
        ...
        assert_matches_type(CmsPage, website_page, path=["response"])
    ...
    def test_method_list(self, client: Hubspot) -> None:
        ...
        assert_matches_type(SyncPage[CmsPage], website_page, path=["response"])
...
class TestAsyncWebsitePages:
    ...
    async def test_method_list(self, async_client: AsyncHubspot) -> None:
        ...
        assert_matches_type(AsyncPage[CmsPage], website_page, path=["response"])
