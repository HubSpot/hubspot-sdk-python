...
class TestABTests:
    ...
    def test_method_create_ab_test_variation(self, client: Hubspot) -> None:
        a_b_test = client.cms.pages.a_b_tests.create_ab_test_variation(
            content_id="contentId",
            variation_name="variationName",
        )
        assert_matches_type(Page, a_b_test, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_create_ab_test_variation(self, client: Hubspot) -> None:
        response = client.cms.pages.a_b_tests.with_raw_response.create_ab_test_variation(
            content_id="contentId",
            variation_name="variationName",
        )
    ...
    def test_streaming_response_create_ab_test_variation(self, client: Hubspot) -> None:
        with client.cms.pages.a_b_tests.with_streaming_response.create_ab_test_variation(
            content_id="contentId",
            variation_name="variationName",
        ) as response:
    ...
    def test_method_end_ab_test(self, client: Hubspot) -> None:
        a_b_test = client.cms.pages.a_b_tests.end_ab_test(
            ab_test_id="abTestId",
            winner_id="winnerId",
        )
    ...
    def test_raw_response_end_ab_test(self, client: Hubspot) -> None:
        response = client.cms.pages.a_b_tests.with_raw_response.end_ab_test(
            ab_test_id="abTestId",
            winner_id="winnerId",
        )
    ...
    def test_streaming_response_end_ab_test(self, client: Hubspot) -> None:
        with client.cms.pages.a_b_tests.with_streaming_response.end_ab_test(
            ab_test_id="abTestId",
            winner_id="winnerId",
        ) as response:
            assert not response.is_closed
    ...
    def test_method_rerun_ab_test(self, client: Hubspot) -> None:
        a_b_test = client.cms.pages.a_b_tests.rerun_ab_test(
            ab_test_id="abTestId",
    ...
    def test_raw_response_rerun_ab_test(self, client: Hubspot) -> None:
        response = client.cms.pages.a_b_tests.with_raw_response.rerun_ab_test(
            ab_test_id="abTestId",
            variation_id="variationId",
        )
    ...
    def test_streaming_response_rerun_ab_test(self, client: Hubspot) -> None:
        with client.cms.pages.a_b_tests.with_streaming_response.rerun_ab_test(
            ab_test_id="abTestId",
            variation_id="variationId",
        ) as response:
            assert not response.is_closed
...
class TestAsyncABTests:
    ...
    async def test_method_create_ab_test_variation(self, async_client: AsyncHubspot) -> None:
        a_b_test = await async_client.cms.pages.a_b_tests.create_ab_test_variation(
            content_id="contentId",
            variation_name="variationName",
        )
        assert_matches_type(Page, a_b_test, path=["response"])
    ...
    async def test_raw_response_create_ab_test_variation(self, async_client: AsyncHubspot) -> None:
        response = await async_client.cms.pages.a_b_tests.with_raw_response.create_ab_test_variation(
            content_id="contentId",
            variation_name="variationName",
        )
    ...
    async def test_streaming_response_create_ab_test_variation(self, async_client: AsyncHubspot) -> None:
        async with async_client.cms.pages.a_b_tests.with_streaming_response.create_ab_test_variation(
            content_id="contentId",
            variation_name="variationName",
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_end_ab_test(self, async_client: AsyncHubspot) -> None:
        a_b_test = await async_client.cms.pages.a_b_tests.end_ab_test(
            ab_test_id="abTestId",
            winner_id="winnerId",
        )
        assert a_b_test is None
    ...
    async def test_raw_response_end_ab_test(self, async_client: AsyncHubspot) -> None:
        response = await async_client.cms.pages.a_b_tests.with_raw_response.end_ab_test(
            ab_test_id="abTestId",
            winner_id="winnerId",
        )
    ...
    async def test_streaming_response_end_ab_test(self, async_client: AsyncHubspot) -> None:
        async with async_client.cms.pages.a_b_tests.with_streaming_response.end_ab_test(
            ab_test_id="abTestId",
            winner_id="winnerId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_rerun_ab_test(self, async_client: AsyncHubspot) -> None:
        a_b_test = await async_client.cms.pages.a_b_tests.rerun_ab_test(
            ab_test_id="abTestId",
            variation_id="variationId",
        )
        assert a_b_test is None
    ...
    async def test_raw_response_rerun_ab_test(self, async_client: AsyncHubspot) -> None:
        response = await async_client.cms.pages.a_b_tests.with_raw_response.rerun_ab_test(
            ab_test_id="abTestId",
            variation_id="variationId",
        )
    ...
    async def test_streaming_response_rerun_ab_test(self, async_client: AsyncHubspot) -> None:
        async with async_client.cms.pages.a_b_tests.with_streaming_response.rerun_ab_test(
            ab_test_id="abTestId",
            variation_id="variationId",
        ) as response:
            assert not response.is_closed
