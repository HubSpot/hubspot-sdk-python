...
class TestMultiLanguage:
    ...
    def test_method_attach_to_lang_group(self, client: HubSpot, respx_mock: MockRouter) -> None:
        respx_mock.post("/cms/pages/2026-03/site-pages/multi-language/attach-to-lang-group").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        multi_language = client.cms.pages.site_pages.multi_language.attach_to_lang_group(
            id="id",
            language="aa",
    ...
    def test_raw_response_attach_to_lang_group(self, client: HubSpot, respx_mock: MockRouter) -> None:
        ...
        multi_language = client.cms.pages.site_pages.multi_language.with_raw_response.attach_to_lang_group(
            id="id",
            language="aa",
            primary_id="primaryId",
        )
    ...
    def test_streaming_response_attach_to_lang_group(self, client: HubSpot, respx_mock: MockRouter) -> None:
        ...
        with client.cms.pages.site_pages.multi_language.with_streaming_response.attach_to_lang_group(
            id="id",
            language="aa",
            primary_id="primaryId",
        ) as multi_language:
    ...
    def test_method_create_language_variation(self, client: HubSpot) -> None:
        multi_language = client.cms.pages.site_pages.multi_language.create_language_variation(
            id="id",
        )
    ...
    def test_raw_response_create_language_variation(self, client: HubSpot) -> None:
        response = client.cms.pages.site_pages.multi_language.with_raw_response.create_language_variation(
            id="id",
        )
    ...
    def test_streaming_response_create_language_variation(self, client: HubSpot) -> None:
        with client.cms.pages.site_pages.multi_language.with_streaming_response.create_language_variation(
            id="id",
        ) as response:
    ...
    def test_method_detach_from_lang_group(self, client: HubSpot, respx_mock: MockRouter) -> None:
        respx_mock.post("/cms/pages/2026-03/site-pages/multi-language/detach-from-lang-group").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        multi_language = client.cms.pages.site_pages.multi_language.detach_from_lang_group(
            id="id",
        )
        assert multi_language.is_closed
        assert multi_language.json() == {"foo": "bar"}
    ...
    def test_raw_response_detach_from_lang_group(self, client: HubSpot, respx_mock: MockRouter) -> None:
        ...
        multi_language = client.cms.pages.site_pages.multi_language.with_raw_response.detach_from_lang_group(
            id="id",
        )
    ...
    def test_streaming_response_detach_from_lang_group(self, client: HubSpot, respx_mock: MockRouter) -> None:
        ...
        with client.cms.pages.site_pages.multi_language.with_streaming_response.detach_from_lang_group(
            id="id",
        ) as multi_language:
            assert not multi_language.is_closed
            assert multi_language.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_set_new_lang_primary(self, client: HubSpot) -> None:
        multi_language = client.cms.pages.site_pages.multi_language.set_new_lang_primary(
            id="id",
        )
    ...
    def test_raw_response_set_new_lang_primary(self, client: HubSpot) -> None:
        response = client.cms.pages.site_pages.multi_language.with_raw_response.set_new_lang_primary(
            id="id",
        )
    ...
    def test_streaming_response_set_new_lang_primary(self, client: HubSpot) -> None:
        with client.cms.pages.site_pages.multi_language.with_streaming_response.set_new_lang_primary(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_update_languages(self, client: HubSpot, respx_mock: MockRouter) -> None:
        respx_mock.post("/cms/pages/2026-03/site-pages/multi-language/update-languages").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        multi_language = client.cms.pages.site_pages.multi_language.update_languages(
            languages={"foo": "aa"},
            primary_id="primaryId",
        )
        assert multi_language.is_closed
    ...
    def test_raw_response_update_languages(self, client: HubSpot, respx_mock: MockRouter) -> None:
        ...
        multi_language = client.cms.pages.site_pages.multi_language.with_raw_response.update_languages(
            languages={"foo": "aa"},
            primary_id="primaryId",
        )
    ...
    def test_streaming_response_update_languages(self, client: HubSpot, respx_mock: MockRouter) -> None:
        ...
        with client.cms.pages.site_pages.multi_language.with_streaming_response.update_languages(
            languages={"foo": "aa"},
            primary_id="primaryId",
        ) as multi_language:
            assert not multi_language.is_closed
...
class TestAsyncMultiLanguage:
    ...
    async def test_method_attach_to_lang_group(self, async_client: AsyncHubSpot, respx_mock: MockRouter) -> None:
        ...
        multi_language = await async_client.cms.pages.site_pages.multi_language.attach_to_lang_group(
            id="id",
            language="aa",
            primary_id="primaryId",
        )
    ...
    async def test_raw_response_attach_to_lang_group(self, async_client: AsyncHubSpot, respx_mock: MockRouter) -> None:
        ...
        multi_language = await async_client.cms.pages.site_pages.multi_language.with_raw_response.attach_to_lang_group(
            id="id",
            language="aa",
            primary_id="primaryId",
        )
    ...
    async def test_streaming_response_attach_to_lang_group(
        ...
        async with async_client.cms.pages.site_pages.multi_language.with_streaming_response.attach_to_lang_group(
            id="id",
            language="aa",
            primary_id="primaryId",
        ) as multi_language:
    ...
    async def test_method_create_language_variation(self, async_client: AsyncHubSpot) -> None:
        multi_language = await async_client.cms.pages.site_pages.multi_language.create_language_variation(
            id="id",
        )
        assert_matches_type(PagesPage, multi_language, path=["response"])
    ...
    async def test_raw_response_create_language_variation(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.pages.site_pages.multi_language.with_raw_response.create_language_variation(
            id="id",
        )
    ...
    async def test_streaming_response_create_language_variation(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.pages.site_pages.multi_language.with_streaming_response.create_language_variation(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_detach_from_lang_group(self, async_client: AsyncHubSpot, respx_mock: MockRouter) -> None:
        ...
        multi_language = await async_client.cms.pages.site_pages.multi_language.detach_from_lang_group(
            id="id",
        )
        assert multi_language.is_closed
        assert await multi_language.json() == {"foo": "bar"}
    ...
    async def test_raw_response_detach_from_lang_group(
        ...
        multi_language = (
            await async_client.cms.pages.site_pages.multi_language.with_raw_response.detach_from_lang_group(
                id="id",
            )
        )
    ...
    async def test_streaming_response_detach_from_lang_group(
        ...
        async with async_client.cms.pages.site_pages.multi_language.with_streaming_response.detach_from_lang_group(
            id="id",
        ) as multi_language:
            assert not multi_language.is_closed
            assert multi_language.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_set_new_lang_primary(self, async_client: AsyncHubSpot) -> None:
        multi_language = await async_client.cms.pages.site_pages.multi_language.set_new_lang_primary(
            id="id",
        )
        assert multi_language is None
    ...
    async def test_raw_response_set_new_lang_primary(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.pages.site_pages.multi_language.with_raw_response.set_new_lang_primary(
            id="id",
        )
    ...
    async def test_streaming_response_set_new_lang_primary(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.pages.site_pages.multi_language.with_streaming_response.set_new_lang_primary(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_update_languages(self, async_client: AsyncHubSpot, respx_mock: MockRouter) -> None:
        ...
        multi_language = await async_client.cms.pages.site_pages.multi_language.update_languages(
            languages={"foo": "aa"},
            primary_id="primaryId",
        )
        assert multi_language.is_closed
    ...
    async def test_raw_response_update_languages(self, async_client: AsyncHubSpot, respx_mock: MockRouter) -> None:
        ...
        multi_language = await async_client.cms.pages.site_pages.multi_language.with_raw_response.update_languages(
            languages={"foo": "aa"},
            primary_id="primaryId",
        )
    ...
    async def test_streaming_response_update_languages(
        ...
        async with async_client.cms.pages.site_pages.multi_language.with_streaming_response.update_languages(
            languages={"foo": "aa"},
            primary_id="primaryId",
        ) as multi_language:
            assert not multi_language.is_closed
