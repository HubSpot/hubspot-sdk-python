...
class TestRevisions:
    ...
    def test_method_get_landing_page_revision(self, client: HubSpot) -> None:
        revision = client.cms.pages.landing_pages.revisions.get_landing_page_revision(
    ...
    def test_raw_response_get_landing_page_revision(self, client: HubSpot) -> None:
        response = client.cms.pages.landing_pages.revisions.with_raw_response.get_landing_page_revision(
            revision_id="revisionId",
            object_id="objectId",
        )
    ...
    def test_streaming_response_get_landing_page_revision(self, client: HubSpot) -> None:
        with client.cms.pages.landing_pages.revisions.with_streaming_response.get_landing_page_revision(
            revision_id="revisionId",
            object_id="objectId",
        ) as response:
    ...
    def test_path_params_get_landing_page_revision(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_id` but received ''"):
            client.cms.pages.landing_pages.revisions.with_raw_response.get_landing_page_revision(
                revision_id="revisionId",
                object_id="",
            )
    ...
    def test_method_list_landing_page_revisions(self, client: HubSpot) -> None:
        revision = client.cms.pages.landing_pages.revisions.list_landing_page_revisions(
            object_id="objectId",
        )
    ...
    def test_raw_response_list_landing_page_revisions(self, client: HubSpot) -> None:
        response = client.cms.pages.landing_pages.revisions.with_raw_response.list_landing_page_revisions(
            object_id="objectId",
        )
    ...
    def test_streaming_response_list_landing_page_revisions(self, client: HubSpot) -> None:
        with client.cms.pages.landing_pages.revisions.with_streaming_response.list_landing_page_revisions(
            object_id="objectId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list_landing_page_revisions(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_id` but received ''"):
            client.cms.pages.landing_pages.revisions.with_raw_response.list_landing_page_revisions(
                object_id="",
            )
    ...
    def test_method_restore_landing_page_revision(self, client: HubSpot) -> None:
        revision = client.cms.pages.landing_pages.revisions.restore_landing_page_revision(
            revision_id="revisionId",
            object_id="objectId",
        )
    ...
    def test_raw_response_restore_landing_page_revision(self, client: HubSpot) -> None:
        response = client.cms.pages.landing_pages.revisions.with_raw_response.restore_landing_page_revision(
            revision_id="revisionId",
            object_id="objectId",
        )
    ...
    def test_streaming_response_restore_landing_page_revision(self, client: HubSpot) -> None:
        with client.cms.pages.landing_pages.revisions.with_streaming_response.restore_landing_page_revision(
            revision_id="revisionId",
            object_id="objectId",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_restore_landing_page_revision(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_id` but received ''"):
            client.cms.pages.landing_pages.revisions.with_raw_response.restore_landing_page_revision(
                revision_id="revisionId",
                object_id="",
            )
    ...
    def test_method_restore_landing_page_revision_to_draft(self, client: HubSpot) -> None:
        revision = client.cms.pages.landing_pages.revisions.restore_landing_page_revision_to_draft(
            revision_id=0,
            object_id="objectId",
        )
        assert_matches_type(PagesPage, revision, path=["response"])
    ...
    def test_raw_response_restore_landing_page_revision_to_draft(self, client: HubSpot) -> None:
        response = client.cms.pages.landing_pages.revisions.with_raw_response.restore_landing_page_revision_to_draft(
            revision_id=0,
            object_id="objectId",
        )
    ...
    def test_streaming_response_restore_landing_page_revision_to_draft(self, client: HubSpot) -> None:
        with client.cms.pages.landing_pages.revisions.with_streaming_response.restore_landing_page_revision_to_draft(
            revision_id=0,
            object_id="objectId",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_restore_landing_page_revision_to_draft(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_id` but received ''"):
            client.cms.pages.landing_pages.revisions.with_raw_response.restore_landing_page_revision_to_draft(
                revision_id=0,
                object_id="",
            )
...
class TestAsyncRevisions:
    ...
    async def test_method_get_landing_page_revision(self, async_client: AsyncHubSpot) -> None:
        revision = await async_client.cms.pages.landing_pages.revisions.get_landing_page_revision(
            revision_id="revisionId",
            object_id="objectId",
        )
        assert_matches_type(PageVersion, revision, path=["response"])
    ...
    async def test_raw_response_get_landing_page_revision(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.pages.landing_pages.revisions.with_raw_response.get_landing_page_revision(
            revision_id="revisionId",
            object_id="objectId",
        )
    ...
    async def test_streaming_response_get_landing_page_revision(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.pages.landing_pages.revisions.with_streaming_response.get_landing_page_revision(
            revision_id="revisionId",
            object_id="objectId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_landing_page_revision(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_id` but received ''"):
            await async_client.cms.pages.landing_pages.revisions.with_raw_response.get_landing_page_revision(
                revision_id="revisionId",
                object_id="",
            )
    ...
    async def test_method_list_landing_page_revisions(self, async_client: AsyncHubSpot) -> None:
        revision = await async_client.cms.pages.landing_pages.revisions.list_landing_page_revisions(
            object_id="objectId",
        )
    ...
    async def test_raw_response_list_landing_page_revisions(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.pages.landing_pages.revisions.with_raw_response.list_landing_page_revisions(
            object_id="objectId",
        )
    ...
    async def test_streaming_response_list_landing_page_revisions(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.pages.landing_pages.revisions.with_streaming_response.list_landing_page_revisions(
            object_id="objectId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list_landing_page_revisions(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_id` but received ''"):
            await async_client.cms.pages.landing_pages.revisions.with_raw_response.list_landing_page_revisions(
                object_id="",
            )
    ...
    async def test_method_restore_landing_page_revision(self, async_client: AsyncHubSpot) -> None:
        revision = await async_client.cms.pages.landing_pages.revisions.restore_landing_page_revision(
            revision_id="revisionId",
            object_id="objectId",
        )
        assert_matches_type(PagesPage, revision, path=["response"])
    ...
    async def test_raw_response_restore_landing_page_revision(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.pages.landing_pages.revisions.with_raw_response.restore_landing_page_revision(
            revision_id="revisionId",
            object_id="objectId",
        )
    ...
    async def test_streaming_response_restore_landing_page_revision(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.pages.landing_pages.revisions.with_streaming_response.restore_landing_page_revision(
            revision_id="revisionId",
            object_id="objectId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_restore_landing_page_revision(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_id` but received ''"):
            await async_client.cms.pages.landing_pages.revisions.with_raw_response.restore_landing_page_revision(
                revision_id="revisionId",
                object_id="",
            )
    ...
    async def test_method_restore_landing_page_revision_to_draft(self, async_client: AsyncHubSpot) -> None:
        revision = await async_client.cms.pages.landing_pages.revisions.restore_landing_page_revision_to_draft(
            revision_id=0,
            object_id="objectId",
        )
        assert_matches_type(PagesPage, revision, path=["response"])
    ...
    async def test_raw_response_restore_landing_page_revision_to_draft(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.pages.landing_pages.revisions.with_raw_response.restore_landing_page_revision_to_draft(
            revision_id=0,
            object_id="objectId",
        )
    ...
    async def test_streaming_response_restore_landing_page_revision_to_draft(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.pages.landing_pages.revisions.with_streaming_response.restore_landing_page_revision_to_draft(
            revision_id=0,
            object_id="objectId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_restore_landing_page_revision_to_draft(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_id` but received ''"):
            await (
                async_client.cms.pages.landing_pages.revisions.with_raw_response.restore_landing_page_revision_to_draft(
                    revision_id=0,
                    object_id="",
                )
            )
