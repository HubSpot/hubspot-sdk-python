...
class TestBatch:
    ...
    def test_method_create_landing_pages(self, client: HubSpot) -> None:
        batch = client.cms.pages.landing_pages.batch.create_landing_pages(
            inputs=[
                {
                    "id": "id",
    ...
    def test_raw_response_create_landing_pages(self, client: HubSpot) -> None:
        response = client.cms.pages.landing_pages.batch.with_raw_response.create_landing_pages(
            inputs=[
                {
                    "id": "id",
                    "ab_status": "automated_loser_variant",
    ...
    def test_streaming_response_create_landing_pages(self, client: HubSpot) -> None:
        with client.cms.pages.landing_pages.batch.with_streaming_response.create_landing_pages(
            inputs=[
                {
                    "id": "id",
                    "ab_status": "automated_loser_variant",
    ...
    def test_method_delete_landing_pages(self, client: HubSpot) -> None:
        batch = client.cms.pages.landing_pages.batch.delete_landing_pages(
            inputs=["string"],
        )
    ...
    def test_raw_response_delete_landing_pages(self, client: HubSpot) -> None:
        response = client.cms.pages.landing_pages.batch.with_raw_response.delete_landing_pages(
            inputs=["string"],
        )
    ...
    def test_streaming_response_delete_landing_pages(self, client: HubSpot) -> None:
        with client.cms.pages.landing_pages.batch.with_streaming_response.delete_landing_pages(
            inputs=["string"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_get_landing_pages(self, client: HubSpot) -> None:
        batch = client.cms.pages.landing_pages.batch.get_landing_pages(
            inputs=["string"],
        )
        assert_matches_type(BatchResponsePage, batch, path=["response"])
    ...
    def test_raw_response_get_landing_pages(self, client: HubSpot) -> None:
        response = client.cms.pages.landing_pages.batch.with_raw_response.get_landing_pages(
            inputs=["string"],
        )
    ...
    def test_streaming_response_get_landing_pages(self, client: HubSpot) -> None:
        with client.cms.pages.landing_pages.batch.with_streaming_response.get_landing_pages(
            inputs=["string"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_update_landing_pages(self, client: HubSpot) -> None:
        batch = client.cms.pages.landing_pages.batch.update_landing_pages(
            inputs=[{}],
        )
        assert_matches_type(BatchResponsePage, batch, path=["response"])
    ...
    def test_raw_response_update_landing_pages(self, client: HubSpot) -> None:
        response = client.cms.pages.landing_pages.batch.with_raw_response.update_landing_pages(
            inputs=[{}],
        )
    ...
    def test_streaming_response_update_landing_pages(self, client: HubSpot) -> None:
        with client.cms.pages.landing_pages.batch.with_streaming_response.update_landing_pages(
            inputs=[{}],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncBatch:
    ...
    async def test_method_create_landing_pages(self, async_client: AsyncHubSpot) -> None:
        batch = await async_client.cms.pages.landing_pages.batch.create_landing_pages(
            inputs=[
                {
                    "id": "id",
                    "ab_status": "automated_loser_variant",
    ...
    async def test_raw_response_create_landing_pages(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.pages.landing_pages.batch.with_raw_response.create_landing_pages(
            inputs=[
                {
                    "id": "id",
                    "ab_status": "automated_loser_variant",
    ...
    async def test_streaming_response_create_landing_pages(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.pages.landing_pages.batch.with_streaming_response.create_landing_pages(
            inputs=[
                {
                    "id": "id",
                    "ab_status": "automated_loser_variant",
    ...
    async def test_method_delete_landing_pages(self, async_client: AsyncHubSpot) -> None:
        batch = await async_client.cms.pages.landing_pages.batch.delete_landing_pages(
            inputs=["string"],
        )
        assert batch is None
    ...
    async def test_raw_response_delete_landing_pages(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.pages.landing_pages.batch.with_raw_response.delete_landing_pages(
            inputs=["string"],
        )
    ...
    async def test_streaming_response_delete_landing_pages(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.pages.landing_pages.batch.with_streaming_response.delete_landing_pages(
            inputs=["string"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get_landing_pages(self, async_client: AsyncHubSpot) -> None:
        batch = await async_client.cms.pages.landing_pages.batch.get_landing_pages(
            inputs=["string"],
        )
        assert_matches_type(BatchResponsePage, batch, path=["response"])
    ...
    async def test_raw_response_get_landing_pages(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.pages.landing_pages.batch.with_raw_response.get_landing_pages(
            inputs=["string"],
        )
    ...
    async def test_streaming_response_get_landing_pages(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.pages.landing_pages.batch.with_streaming_response.get_landing_pages(
            inputs=["string"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_update_landing_pages(self, async_client: AsyncHubSpot) -> None:
        batch = await async_client.cms.pages.landing_pages.batch.update_landing_pages(
            inputs=[{}],
        )
        assert_matches_type(BatchResponsePage, batch, path=["response"])
    ...
    async def test_raw_response_update_landing_pages(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.cms.pages.landing_pages.batch.with_raw_response.update_landing_pages(
            inputs=[{}],
        )
    ...
    async def test_streaming_response_update_landing_pages(self, async_client: AsyncHubSpot) -> None:
        async with async_client.cms.pages.landing_pages.batch.with_streaming_response.update_landing_pages(
            inputs=[{}],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
