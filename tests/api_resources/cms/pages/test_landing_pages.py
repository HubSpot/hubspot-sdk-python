...
class TestLandingPages:
    ...
    def test_method_create(self, client: Hubspot) -> None:
        ...
        assert_matches_type(CmsPage, landing_page, path=["response"])
    ...
    def test_method_list(self, client: Hubspot) -> None:
        ...
        assert_matches_type(SyncPage[CmsPage], landing_page, path=["response"])
...
class TestAsyncLandingPages:
    ...
    async def test_method_list(self, async_client: AsyncHubspot) -> None:
        ...
        assert_matches_type(AsyncPage[CmsPage], landing_page, path=["response"])
