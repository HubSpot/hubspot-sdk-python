...
from hubspot_sdk.types.settings import TaxRateGetResponse, TaxRateListResponse
...
class TestTaxRates:
    ...
    def test_method_list(self, client: Hubspot) -> None:
        ...
        assert_matches_type(TaxRateListResponse, tax_rate, path=["response"])
    ...
    def test_method_get(self, client: Hubspot) -> None:
        ...
        assert_matches_type(TaxRateGetResponse, tax_rate, path=["response"])
