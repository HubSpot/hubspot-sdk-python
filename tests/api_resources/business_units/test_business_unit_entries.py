...
class TestBusinessUnitEntries:
    ...
    def test_method_get_by_user_id(self, client: HubSpot) -> None:
        ...
        assert_matches_type(CollectionResponsePublicBusinessUnitNoPaging, business_unit_entry, path=["response"])
    ...
    def test_raw_response_get_by_user_id(self, client: HubSpot) -> None:
        ...
        business_unit_entry = response.parse()
        assert_matches_type(CollectionResponsePublicBusinessUnitNoPaging, business_unit_entry, path=["response"])
...
class TestAsyncBusinessUnitEntries:
    ...
    async def test_raw_response_get_by_user_id(self, async_client: AsyncHubSpot) -> None:
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        business_unit_entry = await response.parse()
        assert_matches_type(CollectionResponsePublicBusinessUnitNoPaging, business_unit_entry, path=["response"])
