...
class TestBatch:
    ...
    def test_method_get(self, client: Hubspot) -> None:
        batch = client.webhooks.webhook_subscriptions.batch.get(
            inputs=["string"],
        )
    ...
    def test_raw_response_get(self, client: Hubspot) -> None:
        response = client.webhooks.webhook_subscriptions.batch.with_raw_response.get(
            inputs=["string"],
        )
    ...
    def test_streaming_response_get(self, client: Hubspot) -> None:
        with client.webhooks.webhook_subscriptions.batch.with_streaming_response.get(
            inputs=["string"],
        ) as response:
    ...
    def test_method_get_earliest(self, client: Hubspot) -> None:
        batch = client.webhooks.webhook_subscriptions.batch.get_earliest(
            count=1,
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    def test_raw_response_get_earliest(self, client: Hubspot) -> None:
        response = client.webhooks.webhook_subscriptions.batch.with_raw_response.get_earliest(
            count=1,
        )
    ...
    def test_streaming_response_get_earliest(self, client: Hubspot) -> None:
        with client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_earliest(
            count=1,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_get_latest(self, client: Hubspot) -> None:
        batch = client.webhooks.webhook_subscriptions.batch.get_latest(
            count=1,
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    def test_raw_response_get_latest(self, client: Hubspot) -> None:
        response = client.webhooks.webhook_subscriptions.batch.with_raw_response.get_latest(
            count=1,
        )
    ...
    def test_streaming_response_get_latest(self, client: Hubspot) -> None:
        with client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_latest(
            count=1,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_get_local(self, client: Hubspot) -> None:
        batch = client.webhooks.webhook_subscriptions.batch.get_local(
            inputs=["string"],
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    def test_raw_response_get_local(self, client: Hubspot) -> None:
        response = client.webhooks.webhook_subscriptions.batch.with_raw_response.get_local(
            inputs=["string"],
        )
    ...
    def test_streaming_response_get_local(self, client: Hubspot) -> None:
        with client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_local(
            inputs=["string"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_get_local_earliest(self, client: Hubspot) -> None:
        batch = client.webhooks.webhook_subscriptions.batch.get_local_earliest(
            count=1,
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    def test_raw_response_get_local_earliest(self, client: Hubspot) -> None:
        response = client.webhooks.webhook_subscriptions.batch.with_raw_response.get_local_earliest(
            count=1,
        )
    ...
    def test_streaming_response_get_local_earliest(self, client: Hubspot) -> None:
        with client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_local_earliest(
            count=1,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_get_local_latest(self, client: Hubspot) -> None:
        batch = client.webhooks.webhook_subscriptions.batch.get_local_latest(
            count=1,
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    def test_raw_response_get_local_latest(self, client: Hubspot) -> None:
        response = client.webhooks.webhook_subscriptions.batch.with_raw_response.get_local_latest(
            count=1,
        )
    ...
    def test_streaming_response_get_local_latest(self, client: Hubspot) -> None:
        with client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_local_latest(
            count=1,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_get_local_next(self, client: Hubspot) -> None:
        batch = client.webhooks.webhook_subscriptions.batch.get_local_next(
            count=1,
            offset="offset",
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    def test_raw_response_get_local_next(self, client: Hubspot) -> None:
        response = client.webhooks.webhook_subscriptions.batch.with_raw_response.get_local_next(
            count=1,
            offset="offset",
        )
    ...
    def test_streaming_response_get_local_next(self, client: Hubspot) -> None:
        with client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_local_next(
            count=1,
            offset="offset",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get_local_next(self, client: Hubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `offset` but received ''"):
            client.webhooks.webhook_subscriptions.batch.with_raw_response.get_local_next(
                count=1,
                offset="",
            )
    ...
    def test_method_get_next(self, client: Hubspot) -> None:
        batch = client.webhooks.webhook_subscriptions.batch.get_next(
            count=1,
            offset="offset",
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    def test_raw_response_get_next(self, client: Hubspot) -> None:
        response = client.webhooks.webhook_subscriptions.batch.with_raw_response.get_next(
            count=1,
            offset="offset",
        )
    ...
    def test_streaming_response_get_next(self, client: Hubspot) -> None:
        with client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_next(
            count=1,
            offset="offset",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get_next(self, client: Hubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `offset` but received ''"):
            client.webhooks.webhook_subscriptions.batch.with_raw_response.get_next(
                count=1,
                offset="",
            )
    ...
    def test_method_update_subscriptions(self, client: Hubspot) -> None:
        batch = client.webhooks.webhook_subscriptions.batch.update_subscriptions(
            app_id=0,
            inputs=[
                {
                    "id": 0,
    ...
    def test_raw_response_update_subscriptions(self, client: Hubspot) -> None:
        response = client.webhooks.webhook_subscriptions.batch.with_raw_response.update_subscriptions(
            app_id=0,
            inputs=[
                {
                    "id": 0,
    ...
    def test_streaming_response_update_subscriptions(self, client: Hubspot) -> None:
        with client.webhooks.webhook_subscriptions.batch.with_streaming_response.update_subscriptions(
            app_id=0,
            inputs=[
                {
                    "id": 0,
...
class TestAsyncBatch:
    ...
    async def test_method_get(self, async_client: AsyncHubspot) -> None:
        batch = await async_client.webhooks.webhook_subscriptions.batch.get(
            inputs=["string"],
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncHubspot) -> None:
        response = await async_client.webhooks.webhook_subscriptions.batch.with_raw_response.get(
            inputs=["string"],
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncHubspot) -> None:
        async with async_client.webhooks.webhook_subscriptions.batch.with_streaming_response.get(
            inputs=["string"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get_earliest(self, async_client: AsyncHubspot) -> None:
        batch = await async_client.webhooks.webhook_subscriptions.batch.get_earliest(
            count=1,
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    async def test_raw_response_get_earliest(self, async_client: AsyncHubspot) -> None:
        response = await async_client.webhooks.webhook_subscriptions.batch.with_raw_response.get_earliest(
            count=1,
        )
    ...
    async def test_streaming_response_get_earliest(self, async_client: AsyncHubspot) -> None:
        async with async_client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_earliest(
            count=1,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get_latest(self, async_client: AsyncHubspot) -> None:
        batch = await async_client.webhooks.webhook_subscriptions.batch.get_latest(
            count=1,
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    async def test_raw_response_get_latest(self, async_client: AsyncHubspot) -> None:
        response = await async_client.webhooks.webhook_subscriptions.batch.with_raw_response.get_latest(
            count=1,
        )
    ...
    async def test_streaming_response_get_latest(self, async_client: AsyncHubspot) -> None:
        async with async_client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_latest(
            count=1,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get_local(self, async_client: AsyncHubspot) -> None:
        batch = await async_client.webhooks.webhook_subscriptions.batch.get_local(
            inputs=["string"],
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    async def test_raw_response_get_local(self, async_client: AsyncHubspot) -> None:
        response = await async_client.webhooks.webhook_subscriptions.batch.with_raw_response.get_local(
            inputs=["string"],
        )
    ...
    async def test_streaming_response_get_local(self, async_client: AsyncHubspot) -> None:
        async with async_client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_local(
            inputs=["string"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get_local_earliest(self, async_client: AsyncHubspot) -> None:
        batch = await async_client.webhooks.webhook_subscriptions.batch.get_local_earliest(
            count=1,
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    async def test_raw_response_get_local_earliest(self, async_client: AsyncHubspot) -> None:
        response = await async_client.webhooks.webhook_subscriptions.batch.with_raw_response.get_local_earliest(
            count=1,
        )
    ...
    async def test_streaming_response_get_local_earliest(self, async_client: AsyncHubspot) -> None:
        async with async_client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_local_earliest(
            count=1,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get_local_latest(self, async_client: AsyncHubspot) -> None:
        batch = await async_client.webhooks.webhook_subscriptions.batch.get_local_latest(
            count=1,
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    async def test_raw_response_get_local_latest(self, async_client: AsyncHubspot) -> None:
        response = await async_client.webhooks.webhook_subscriptions.batch.with_raw_response.get_local_latest(
            count=1,
        )
    ...
    async def test_streaming_response_get_local_latest(self, async_client: AsyncHubspot) -> None:
        async with async_client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_local_latest(
            count=1,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get_local_next(self, async_client: AsyncHubspot) -> None:
        batch = await async_client.webhooks.webhook_subscriptions.batch.get_local_next(
            count=1,
            offset="offset",
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    async def test_raw_response_get_local_next(self, async_client: AsyncHubspot) -> None:
        response = await async_client.webhooks.webhook_subscriptions.batch.with_raw_response.get_local_next(
            count=1,
            offset="offset",
        )
    ...
    async def test_streaming_response_get_local_next(self, async_client: AsyncHubspot) -> None:
        async with async_client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_local_next(
            count=1,
            offset="offset",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_local_next(self, async_client: AsyncHubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `offset` but received ''"):
            await async_client.webhooks.webhook_subscriptions.batch.with_raw_response.get_local_next(
                count=1,
                offset="",
            )
    ...
    async def test_method_get_next(self, async_client: AsyncHubspot) -> None:
        batch = await async_client.webhooks.webhook_subscriptions.batch.get_next(
            count=1,
            offset="offset",
        )
        assert_matches_type(BatchResponseJournalFetchResponse, batch, path=["response"])
    ...
    async def test_raw_response_get_next(self, async_client: AsyncHubspot) -> None:
        response = await async_client.webhooks.webhook_subscriptions.batch.with_raw_response.get_next(
            count=1,
            offset="offset",
        )
    ...
    async def test_streaming_response_get_next(self, async_client: AsyncHubspot) -> None:
        async with async_client.webhooks.webhook_subscriptions.batch.with_streaming_response.get_next(
            count=1,
            offset="offset",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_next(self, async_client: AsyncHubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `offset` but received ''"):
            await async_client.webhooks.webhook_subscriptions.batch.with_raw_response.get_next(
                count=1,
                offset="",
            )
    ...
    async def test_method_update_subscriptions(self, async_client: AsyncHubspot) -> None:
        batch = await async_client.webhooks.webhook_subscriptions.batch.update_subscriptions(
            app_id=0,
            inputs=[
                {
                    "id": 0,
    ...
    async def test_raw_response_update_subscriptions(self, async_client: AsyncHubspot) -> None:
        response = await async_client.webhooks.webhook_subscriptions.batch.with_raw_response.update_subscriptions(
            app_id=0,
            inputs=[
                {
                    "id": 0,
    ...
    async def test_streaming_response_update_subscriptions(self, async_client: AsyncHubspot) -> None:
        async with async_client.webhooks.webhook_subscriptions.batch.with_streaming_response.update_subscriptions(
            app_id=0,
            inputs=[
                {
                    "id": 0,
