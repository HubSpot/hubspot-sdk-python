...
from hubspot_sdk.types.crm import BatchResponseVoid
...
class TestConfigurations:
    ...
    def test_method_list(self, client: Hubspot) -> None:
        ...
        assert_matches_type(
            CollectionResponsePublicAssociationDefinitionUserConfiguration, configuration, path=["response"]
        )
    ...
    def test_method_batch_create(self, client: Hubspot) -> None:
        configuration = client.crm.associations.schema.v4.configurations.batch_create(
    ...
    def test_raw_response_batch_create(self, client: Hubspot) -> None:
        response = client.crm.associations.schema.v4.configurations.with_raw_response.batch_create(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    def test_streaming_response_batch_create(self, client: Hubspot) -> None:
        with client.crm.associations.schema.v4.configurations.with_streaming_response.batch_create(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    def test_path_params_batch_create(self, client: Hubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `from_object_type` but received ''"):
            client.crm.associations.schema.v4.configurations.with_raw_response.batch_create(
                to_object_type="toObjectType",
                from_object_type="",
                inputs=[
                    {
    ...
    def test_method_batch_delete(self, client: Hubspot) -> None:
        configuration = client.crm.associations.schema.v4.configurations.batch_delete(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
        ...
        assert_matches_type(BatchResponseVoid, configuration, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_batch_delete(self, client: Hubspot) -> None:
        response = client.crm.associations.schema.v4.configurations.with_raw_response.batch_delete(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    def test_streaming_response_batch_delete(self, client: Hubspot) -> None:
        with client.crm.associations.schema.v4.configurations.with_streaming_response.batch_delete(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    def test_path_params_batch_delete(self, client: Hubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `from_object_type` but received ''"):
            client.crm.associations.schema.v4.configurations.with_raw_response.batch_delete(
                to_object_type="toObjectType",
                from_object_type="",
                inputs=[
                    {
    ...
    def test_method_batch_update(self, client: Hubspot) -> None:
        configuration = client.crm.associations.schema.v4.configurations.batch_update(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    def test_raw_response_batch_update(self, client: Hubspot) -> None:
        response = client.crm.associations.schema.v4.configurations.with_raw_response.batch_update(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    def test_streaming_response_batch_update(self, client: Hubspot) -> None:
        with client.crm.associations.schema.v4.configurations.with_streaming_response.batch_update(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    def test_path_params_batch_update(self, client: Hubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `from_object_type` but received ''"):
            client.crm.associations.schema.v4.configurations.with_raw_response.batch_update(
                to_object_type="toObjectType",
                from_object_type="",
                inputs=[
                    {
...
class TestAsyncConfigurations:
    ...
    async def test_method_batch_create(self, async_client: AsyncHubspot) -> None:
        configuration = await async_client.crm.associations.schema.v4.configurations.batch_create(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    async def test_raw_response_batch_create(self, async_client: AsyncHubspot) -> None:
        response = await async_client.crm.associations.schema.v4.configurations.with_raw_response.batch_create(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    async def test_streaming_response_batch_create(self, async_client: AsyncHubspot) -> None:
        async with async_client.crm.associations.schema.v4.configurations.with_streaming_response.batch_create(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    async def test_path_params_batch_create(self, async_client: AsyncHubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `from_object_type` but received ''"):
            await async_client.crm.associations.schema.v4.configurations.with_raw_response.batch_create(
                to_object_type="toObjectType",
                from_object_type="",
                inputs=[
                    {
    ...
    async def test_method_batch_delete(self, async_client: AsyncHubspot) -> None:
        configuration = await async_client.crm.associations.schema.v4.configurations.batch_delete(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    async def test_raw_response_batch_delete(self, async_client: AsyncHubspot) -> None:
        response = await async_client.crm.associations.schema.v4.configurations.with_raw_response.batch_delete(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    async def test_streaming_response_batch_delete(self, async_client: AsyncHubspot) -> None:
        async with async_client.crm.associations.schema.v4.configurations.with_streaming_response.batch_delete(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    async def test_path_params_batch_delete(self, async_client: AsyncHubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `from_object_type` but received ''"):
            await async_client.crm.associations.schema.v4.configurations.with_raw_response.batch_delete(
                to_object_type="toObjectType",
                from_object_type="",
                inputs=[
                    {
    ...
    async def test_method_batch_update(self, async_client: AsyncHubspot) -> None:
        configuration = await async_client.crm.associations.schema.v4.configurations.batch_update(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    async def test_raw_response_batch_update(self, async_client: AsyncHubspot) -> None:
        response = await async_client.crm.associations.schema.v4.configurations.with_raw_response.batch_update(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    async def test_streaming_response_batch_update(self, async_client: AsyncHubspot) -> None:
        async with async_client.crm.associations.schema.v4.configurations.with_streaming_response.batch_update(
            to_object_type="toObjectType",
            from_object_type="fromObjectType",
            inputs=[
                {
    ...
    async def test_path_params_batch_update(self, async_client: AsyncHubspot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `from_object_type` but received ''"):
            await async_client.crm.associations.schema.v4.configurations.with_raw_response.batch_update(
                to_object_type="toObjectType",
                from_object_type="",
                inputs=[
                    {
