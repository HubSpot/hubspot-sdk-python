...
class TestBatch:
    ...
    def test_method_archive(self, client: HubSpot) -> None:
        batch = client.crm.objects.leads.batch.archive(
            inputs=[{"id": "id"}],
        )
    ...
    def test_raw_response_archive(self, client: HubSpot) -> None:
        response = client.crm.objects.leads.batch.with_raw_response.archive(
            inputs=[{"id": "id"}],
        )
    ...
    def test_streaming_response_archive(self, client: HubSpot) -> None:
        with client.crm.objects.leads.batch.with_streaming_response.archive(
            inputs=[{"id": "id"}],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncBatch:
    ...
    async def test_method_archive(self, async_client: AsyncHubSpot) -> None:
        batch = await async_client.crm.objects.leads.batch.archive(
            inputs=[{"id": "id"}],
        )
        assert batch is None
    ...
    async def test_raw_response_archive(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.crm.objects.leads.batch.with_raw_response.archive(
            inputs=[{"id": "id"}],
        )
    ...
    async def test_streaming_response_archive(self, async_client: AsyncHubSpot) -> None:
        async with async_client.crm.objects.leads.batch.with_streaming_response.archive(
            inputs=[{"id": "id"}],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
