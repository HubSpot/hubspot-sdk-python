...
class TestBatch:
    ...
    def test_method_upsert(self, client: Hubspot) -> None:
        batch = client.crm.objects.leads.batch.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    def test_raw_response_upsert(self, client: Hubspot) -> None:
        response = client.crm.objects.leads.batch.with_raw_response.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    def test_streaming_response_upsert(self, client: Hubspot) -> None:
        with client.crm.objects.leads.batch.with_streaming_response.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
...
class TestAsyncBatch:
    ...
    async def test_method_upsert(self, async_client: AsyncHubspot) -> None:
        batch = await async_client.crm.objects.leads.batch.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    async def test_raw_response_upsert(self, async_client: AsyncHubspot) -> None:
        response = await async_client.crm.objects.leads.batch.with_raw_response.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    async def test_streaming_response_upsert(self, async_client: AsyncHubspot) -> None:
        async with async_client.crm.objects.leads.batch.with_streaming_response.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
