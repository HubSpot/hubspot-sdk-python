...
class TestBatch:
    ...
    def test_method_create(self, client: HubSpot) -> None:
        batch = client.crm.objects.contacts.batch.create(
    ...
    def test_raw_response_create(self, client: HubSpot) -> None:
        response = client.crm.objects.contacts.batch.with_raw_response.create(
            inputs=[{"properties": {"foo": "string"}}],
        )
    ...
    def test_streaming_response_create(self, client: HubSpot) -> None:
        with client.crm.objects.contacts.batch.with_streaming_response.create(
            inputs=[{"properties": {"foo": "string"}}],
        ) as response:
    ...
    def test_method_update(self, client: HubSpot) -> None:
        batch = client.crm.objects.contacts.batch.update(
            inputs=[
                {
                    "id": "id",
    ...
    def test_raw_response_update(self, client: HubSpot) -> None:
        response = client.crm.objects.contacts.batch.with_raw_response.update(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    def test_streaming_response_update(self, client: HubSpot) -> None:
        with client.crm.objects.contacts.batch.with_streaming_response.update(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    def test_method_read(self, client: HubSpot) -> None:
        batch = client.crm.objects.contacts.batch.read(
            inputs=[{"id": "id"}],
            properties=["string"],
    ...
    def test_raw_response_read(self, client: HubSpot) -> None:
        response = client.crm.objects.contacts.batch.with_raw_response.read(
            inputs=[{"id": "id"}],
            properties=["string"],
            properties_with_history=["string"],
        )
    ...
    def test_streaming_response_read(self, client: HubSpot) -> None:
        with client.crm.objects.contacts.batch.with_streaming_response.read(
            inputs=[{"id": "id"}],
            properties=["string"],
            properties_with_history=["string"],
        ) as response:
    ...
    def test_method_upsert(self, client: HubSpot) -> None:
        batch = client.crm.objects.contacts.batch.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    def test_raw_response_upsert(self, client: HubSpot) -> None:
        response = client.crm.objects.contacts.batch.with_raw_response.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    def test_streaming_response_upsert(self, client: HubSpot) -> None:
        with client.crm.objects.contacts.batch.with_streaming_response.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
...
class TestAsyncBatch:
    ...
    async def test_method_create(self, async_client: AsyncHubSpot) -> None:
        batch = await async_client.crm.objects.contacts.batch.create(
            inputs=[{"properties": {"foo": "string"}}],
        )
        assert_matches_type(BatchResponseSimplePublicObject, batch, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.crm.objects.contacts.batch.with_raw_response.create(
            inputs=[{"properties": {"foo": "string"}}],
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncHubSpot) -> None:
        async with async_client.crm.objects.contacts.batch.with_streaming_response.create(
            inputs=[{"properties": {"foo": "string"}}],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_update(self, async_client: AsyncHubSpot) -> None:
        batch = await async_client.crm.objects.contacts.batch.update(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    async def test_raw_response_update(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.crm.objects.contacts.batch.with_raw_response.update(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    async def test_streaming_response_update(self, async_client: AsyncHubSpot) -> None:
        async with async_client.crm.objects.contacts.batch.with_streaming_response.update(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    async def test_method_read(self, async_client: AsyncHubSpot) -> None:
        batch = await async_client.crm.objects.contacts.batch.read(
            inputs=[{"id": "id"}],
            properties=["string"],
            properties_with_history=["string"],
        )
    ...
    async def test_raw_response_read(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.crm.objects.contacts.batch.with_raw_response.read(
            inputs=[{"id": "id"}],
            properties=["string"],
            properties_with_history=["string"],
        )
    ...
    async def test_streaming_response_read(self, async_client: AsyncHubSpot) -> None:
        async with async_client.crm.objects.contacts.batch.with_streaming_response.read(
            inputs=[{"id": "id"}],
            properties=["string"],
            properties_with_history=["string"],
        ) as response:
    ...
    async def test_method_upsert(self, async_client: AsyncHubSpot) -> None:
        batch = await async_client.crm.objects.contacts.batch.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    async def test_raw_response_upsert(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.crm.objects.contacts.batch.with_raw_response.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    async def test_streaming_response_upsert(self, async_client: AsyncHubSpot) -> None:
        async with async_client.crm.objects.contacts.batch.with_streaming_response.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
