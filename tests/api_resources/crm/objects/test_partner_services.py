...
class TestPartnerServices:
    ...
    def test_method_list(self, client: Hubspot) -> None:
        ...
        assert_matches_type(SyncPage[SimplePublicObjectWithAssociations], partner_service, path=["response"])
    ...
    def test_streaming_response_list(self, client: Hubspot) -> None:
        with client.crm.objects.partner_services.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_streaming_response_search(self, client: Hubspot) -> None:
        with client.crm.objects.partner_services.with_streaming_response.search() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncPartnerServices:
    ...
    async def test_method_list(self, async_client: AsyncHubspot) -> None:
        ...
        assert_matches_type(AsyncPage[SimplePublicObjectWithAssociations], partner_service, path=["response"])
    ...
    async def test_streaming_response_list(self, async_client: AsyncHubspot) -> None:
        async with async_client.crm.objects.partner_services.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_streaming_response_search(self, async_client: AsyncHubspot) -> None:
        async with async_client.crm.objects.partner_services.with_streaming_response.search() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
