...
class TestTaxes:
    ...
    def test_method_create(self, client: Hubspot) -> None:
        ...
        assert_matches_type(BatchResponseSimplePublicObject, tax, path=["response"])
    ...
    def test_streaming_response_search(self, client: Hubspot) -> None:
        with client.crm.objects.taxes.with_streaming_response.search(
            after="after",
            filter_groups=[
                {
                    "filters": [
    ...
    def test_method_upsert(self, client: Hubspot) -> None:
        tax = client.crm.objects.taxes.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
        ...
        assert_matches_type(BatchResponseSimplePublicUpsertObject, tax, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_upsert(self, client: Hubspot) -> None:
        response = client.crm.objects.taxes.with_raw_response.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    def test_streaming_response_upsert(self, client: Hubspot) -> None:
        with client.crm.objects.taxes.with_streaming_response.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
...
class TestAsyncTaxes:
    ...
    async def test_streaming_response_search(self, async_client: AsyncHubspot) -> None:
        async with async_client.crm.objects.taxes.with_streaming_response.search(
            after="after",
            filter_groups=[
                {
                    "filters": [
    ...
    async def test_method_upsert(self, async_client: AsyncHubspot) -> None:
        tax = await async_client.crm.objects.taxes.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    async def test_raw_response_upsert(self, async_client: AsyncHubspot) -> None:
        response = await async_client.crm.objects.taxes.with_raw_response.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
    ...
    async def test_streaming_response_upsert(self, async_client: AsyncHubspot) -> None:
        async with async_client.crm.objects.taxes.with_streaming_response.upsert(
            inputs=[
                {
                    "id": "id",
                    "properties": {"foo": "string"},
