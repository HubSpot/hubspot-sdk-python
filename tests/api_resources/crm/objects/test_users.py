...
class TestUsers:
    ...
    def test_method_list(self, client: Hubspot) -> None:
        user = client.crm.objects.users.list()
    ...
    def test_raw_response_list(self, client: Hubspot) -> None:
        response = client.crm.objects.users.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Hubspot) -> None:
        with client.crm.objects.users.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_search(self, client: Hubspot) -> None:
        user = client.crm.objects.users.search(
            after="after",
            filter_groups=[
                {
                    "filters": [
    ...
    def test_raw_response_search(self, client: Hubspot) -> None:
        response = client.crm.objects.users.with_raw_response.search(
            after="after",
            filter_groups=[
                {
                    "filters": [
    ...
    def test_streaming_response_search(self, client: Hubspot) -> None:
        with client.crm.objects.users.with_streaming_response.search(
            after="after",
            filter_groups=[
                {
                    "filters": [
...
class TestAsyncUsers:
    ...
    async def test_method_list(self, async_client: AsyncHubspot) -> None:
        user = await async_client.crm.objects.users.list()
    ...
    async def test_raw_response_list(self, async_client: AsyncHubspot) -> None:
        response = await async_client.crm.objects.users.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncHubspot) -> None:
        async with async_client.crm.objects.users.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_search(self, async_client: AsyncHubspot) -> None:
        user = await async_client.crm.objects.users.search(
            after="after",
            filter_groups=[
                {
                    "filters": [
    ...
    async def test_raw_response_search(self, async_client: AsyncHubspot) -> None:
        response = await async_client.crm.objects.users.with_raw_response.search(
            after="after",
            filter_groups=[
                {
                    "filters": [
    ...
    async def test_streaming_response_search(self, async_client: AsyncHubspot) -> None:
        async with async_client.crm.objects.users.with_streaming_response.search(
            after="after",
            filter_groups=[
                {
                    "filters": [
