...
class TestObjects:
    ...
    def test_method_list(self, client: HubSpot) -> None:
        object_ = client.crm.objects.objects.list(
            object_type="objectType",
        )
        assert_matches_type(SyncPage[SimplePublicObjectWithAssociations], object_, path=["response"])
    ...
    def test_raw_response_list(self, client: HubSpot) -> None:
        response = client.crm.objects.objects.with_raw_response.list(
            object_type="objectType",
        )
    ...
    def test_streaming_response_list(self, client: HubSpot) -> None:
        with client.crm.objects.objects.with_streaming_response.list(
            object_type="objectType",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_type` but received ''"):
            client.crm.objects.objects.with_raw_response.list(
                object_type="",
            )
    ...
    def test_method_delete(self, client: HubSpot) -> None:
        object_ = client.crm.objects.objects.delete(
            object_id="objectId",
            object_type="objectType",
        )
    ...
    def test_raw_response_delete(self, client: HubSpot) -> None:
        response = client.crm.objects.objects.with_raw_response.delete(
            object_id="objectId",
            object_type="objectType",
        )
    ...
    def test_streaming_response_delete(self, client: HubSpot) -> None:
        with client.crm.objects.objects.with_streaming_response.delete(
            object_id="objectId",
            object_type="objectType",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_delete(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_type` but received ''"):
            client.crm.objects.objects.with_raw_response.delete(
                object_id="objectId",
                object_type="",
            )
    ...
    def test_method_read(self, client: HubSpot) -> None:
        object_ = client.crm.objects.objects.read(
            object_id="objectId",
            object_type="objectType",
        )
        assert_matches_type(SimplePublicObjectWithAssociations, object_, path=["response"])
    ...
    def test_raw_response_read(self, client: HubSpot) -> None:
        response = client.crm.objects.objects.with_raw_response.read(
            object_id="objectId",
            object_type="objectType",
        )
    ...
    def test_streaming_response_read(self, client: HubSpot) -> None:
        with client.crm.objects.objects.with_streaming_response.read(
            object_id="objectId",
            object_type="objectType",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_read(self, client: HubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_type` but received ''"):
            client.crm.objects.objects.with_raw_response.read(
                object_id="objectId",
                object_type="",
            )
...
class TestAsyncObjects:
    ...
    async def test_method_list(self, async_client: AsyncHubSpot) -> None:
        object_ = await async_client.crm.objects.objects.list(
            object_type="objectType",
        )
        assert_matches_type(AsyncPage[SimplePublicObjectWithAssociations], object_, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.crm.objects.objects.with_raw_response.list(
            object_type="objectType",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncHubSpot) -> None:
        async with async_client.crm.objects.objects.with_streaming_response.list(
            object_type="objectType",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_type` but received ''"):
            await async_client.crm.objects.objects.with_raw_response.list(
                object_type="",
            )
    ...
    async def test_method_delete(self, async_client: AsyncHubSpot) -> None:
        object_ = await async_client.crm.objects.objects.delete(
            object_id="objectId",
            object_type="objectType",
        )
        assert object_ is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.crm.objects.objects.with_raw_response.delete(
            object_id="objectId",
            object_type="objectType",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncHubSpot) -> None:
        async with async_client.crm.objects.objects.with_streaming_response.delete(
            object_id="objectId",
            object_type="objectType",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_delete(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_type` but received ''"):
            await async_client.crm.objects.objects.with_raw_response.delete(
                object_id="objectId",
                object_type="",
            )
    ...
    async def test_method_read(self, async_client: AsyncHubSpot) -> None:
        object_ = await async_client.crm.objects.objects.read(
            object_id="objectId",
            object_type="objectType",
        )
        assert_matches_type(SimplePublicObjectWithAssociations, object_, path=["response"])
    ...
    async def test_raw_response_read(self, async_client: AsyncHubSpot) -> None:
        response = await async_client.crm.objects.objects.with_raw_response.read(
            object_id="objectId",
            object_type="objectType",
        )
    ...
    async def test_streaming_response_read(self, async_client: AsyncHubSpot) -> None:
        async with async_client.crm.objects.objects.with_streaming_response.read(
            object_id="objectId",
            object_type="objectType",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_read(self, async_client: AsyncHubSpot) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `object_type` but received ''"):
            await async_client.crm.objects.objects.with_raw_response.read(
                object_id="objectId",
                object_type="",
            )
