...
class TestPostalMail:
    ...
    def test_method_create(self, client: Hubspot) -> None:
        ...
        assert_matches_type(CreatedResponseSimplePublicObject, postal_mail, path=["response"])
    ...
    def test_streaming_response_search(self, client: Hubspot) -> None:
        with client.crm.objects.postal_mail.with_streaming_response.search() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncPostalMail:
    ...
    async def test_streaming_response_search(self, async_client: AsyncHubspot) -> None:
        async with async_client.crm.objects.postal_mail.with_streaming_response.search() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
