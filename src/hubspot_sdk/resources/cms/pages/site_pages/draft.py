...
from .....types.cms.pages.site_pages import draft_update_draft_params
...
class DraftResource(SyncAPIResource):
    ...
    def get_draft(
        ...
        *,
        ...
        return self._get(
            path_template("/cms/pages/2026-03/site-pages/{object_id}/draft", object_id=object_id),
    ...
    def publish_draft(
        ...
        *,
        ...
        return self._post(
            path_template("/cms/pages/2026-03/site-pages/{object_id}/draft/push-live", object_id=object_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
        ...
        *,
        ...
        return self._patch(
            ...
            body=maybe_transform(
                ...
                draft_update_draft_params.DraftUpdateDraftParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
