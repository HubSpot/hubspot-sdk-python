...
class SitePagesResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template("/cms/pages/2026-03/site-pages/{object_id}", object_id=object_id),
            body=maybe_transform(
                {
                    "id": id,
                    "ab_status": ab_status,
    ...
    def clone(
        ...
        *,
        ...
        """
        return self._post(
            "/cms/pages/2026-03/site-pages/clone",
            body=maybe_transform(
                {
                    "id": id,
    ...
    def schedule(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            "/cms/pages/2026-03/site-pages/schedule",
            body=maybe_transform(
                {
                    "id": id,
                    "publish_date": publish_date,
...
class SitePagesResourceWithRawResponse:
    ...
    def ab_test(self) -> AbTestResourceWithRawResponse:
        return AbTestResourceWithRawResponse(self._site_pages.ab_test)

    @cached_property
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._site_pages.batch)

    @cached_property
    def draft(self) -> DraftResourceWithRawResponse:
        return DraftResourceWithRawResponse(self._site_pages.draft)

    @cached_property
    def multi_language(self) -> MultiLanguageResourceWithRawResponse:
        return MultiLanguageResourceWithRawResponse(self._site_pages.multi_language)

    @cached_property
    def revisions(self) -> RevisionsResourceWithRawResponse:
        return RevisionsResourceWithRawResponse(self._site_pages.revisions)
...
class AsyncSitePagesResourceWithRawResponse:
    ...
    def ab_test(self) -> AsyncAbTestResourceWithRawResponse:
        return AsyncAbTestResourceWithRawResponse(self._site_pages.ab_test)

    @cached_property
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._site_pages.batch)

    @cached_property
    def draft(self) -> AsyncDraftResourceWithRawResponse:
        return AsyncDraftResourceWithRawResponse(self._site_pages.draft)

    @cached_property
    def multi_language(self) -> AsyncMultiLanguageResourceWithRawResponse:
        return AsyncMultiLanguageResourceWithRawResponse(self._site_pages.multi_language)

    @cached_property
    def revisions(self) -> AsyncRevisionsResourceWithRawResponse:
        return AsyncRevisionsResourceWithRawResponse(self._site_pages.revisions)
...
class SitePagesResourceWithStreamingResponse:
    ...
    def ab_test(self) -> AbTestResourceWithStreamingResponse:
        return AbTestResourceWithStreamingResponse(self._site_pages.ab_test)

    @cached_property
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._site_pages.batch)

    @cached_property
    def draft(self) -> DraftResourceWithStreamingResponse:
        return DraftResourceWithStreamingResponse(self._site_pages.draft)

    @cached_property
    def multi_language(self) -> MultiLanguageResourceWithStreamingResponse:
        return MultiLanguageResourceWithStreamingResponse(self._site_pages.multi_language)

    @cached_property
    def revisions(self) -> RevisionsResourceWithStreamingResponse:
        return RevisionsResourceWithStreamingResponse(self._site_pages.revisions)
...
class AsyncSitePagesResourceWithStreamingResponse:
    ...
    def ab_test(self) -> AsyncAbTestResourceWithStreamingResponse:
        return AsyncAbTestResourceWithStreamingResponse(self._site_pages.ab_test)

    @cached_property
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._site_pages.batch)

    @cached_property
    def draft(self) -> AsyncDraftResourceWithStreamingResponse:
        return AsyncDraftResourceWithStreamingResponse(self._site_pages.draft)

    @cached_property
    def multi_language(self) -> AsyncMultiLanguageResourceWithStreamingResponse:
        return AsyncMultiLanguageResourceWithStreamingResponse(self._site_pages.multi_language)

    @cached_property
    def revisions(self) -> AsyncRevisionsResourceWithStreamingResponse:
        return AsyncRevisionsResourceWithStreamingResponse(self._site_pages.revisions)
