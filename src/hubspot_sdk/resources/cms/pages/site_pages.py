...
from ....types.cms.pages import (
    site_page_get_params,
    site_page_list_params,
    site_page_clone_params,
    site_page_create_params,
    site_page_delete_params,
    site_page_update_params,
    site_page_schedule_params,
    site_page_get_batch_params,
    site_page_end_ab_test_params,
    site_page_create_batch_params,
    site_page_delete_batch_params,
    site_page_update_batch_params,
    site_page_update_draft_params,
    site_page_rerun_ab_test_params,
    site_page_list_revisions_params,
    site_page_update_languages_params,
    site_page_attach_to_lang_group_params,
    site_page_set_new_lang_primary_params,
    site_page_detach_from_lang_group_params,
    site_page_create_ab_test_variation_params,
    site_page_create_language_variation_params,
)
...
class SitePagesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        content_type_category: Literal["0", "1", "10", "11", "12", "2", "3", "4", "5", "6", "7", "8", "9"],
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                site_page_create_params.SitePageCreateParams,
            ),
    ...
    def update(
        ...
        *,
        ...
        Args:
          ...
          archived: Specifies whether to update deleted Site Pages. Defaults to `false`.
        ...
        return self._patch(
            f"/cms/v3/pages/site-pages/{object_id}",
            body=maybe_transform(
                {
                    "id": id,
                    "ab_status": ab_status,
                ...
                site_page_update_params.SitePageUpdateParams,
            ),
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"archived": archived}, site_page_update_params.SitePageUpdateParams),
            ),
            cast_to=Page,
        )
    ...
    def list(
        ...
        *,
        ...
        Args:
          ...
          archived: Specifies whether to return deleted Site Pages. Defaults to `false`.

          created_after: Only return Site Pages created after the specified time.

          created_at: Only return Site Pages created at exactly the specified time.

          created_before: Only return Site Pages created before the specified time.
          ...
          updated_after: Only return Site Pages last updated after the specified time.

          updated_at: Only return Site Pages last updated at exactly the specified time.

          updated_before: Only return Site Pages last updated before the specified time.
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    site_page_list_params.SitePageListParams,
                ),
            ),
            model=Page,
        )
        ...
        *,
        ...
        return self._delete(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"archived": archived}, site_page_delete_params.SitePageDeleteParams),
            ),
            cast_to=NoneType,
        )
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                site_page_attach_to_lang_group_params.SitePageAttachToLangGroupParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                site_page_clone_params.SitePageCloneParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                site_page_create_ab_test_variation_params.SitePageCreateAbTestVariationParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def create_batch(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"inputs": inputs}, site_page_create_batch_params.SitePageCreateBatchParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                site_page_create_language_variation_params.SitePageCreateLanguageVariationParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def delete_batch(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"inputs": inputs}, site_page_delete_batch_params.SitePageDeleteBatchParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def detach_from_lang_group(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"id": id}, site_page_detach_from_lang_group_params.SitePageDetachFromLangGroupParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                site_page_end_ab_test_params.SitePageEndAbTestParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    site_page_get_params.SitePageGetParams,
                ),
            ),
            cast_to=Page,
        )
    ...
    def get_batch(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"inputs": inputs}, site_page_get_batch_params.SitePageGetBatchParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"archived": archived}, site_page_get_batch_params.SitePageGetBatchParams),
            ),
            cast_to=BatchResponsePage,
        )
    ...
    def get_draft(
        ...
        *,
        ...
        if not object_id:
            raise ValueError(f"Expected a non-empty value for `object_id` but received {object_id!r}")
        return self._get(
            f"/cms/v3/pages/site-pages/{object_id}/draft",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=Page,
    ...
    def get_revision(
        ...
        *,
        ...
        return self._get(
            f"/cms/v3/pages/site-pages/{object_id}/revisions/{revision_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=VersionPage,
    ...
    def publish_draft(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            f"/cms/v3/pages/site-pages/{object_id}/draft/push-live",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                site_page_rerun_ab_test_params.SitePageRerunAbTestParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def reset_draft(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            f"/cms/v3/pages/site-pages/{object_id}/draft/reset",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def restore_revision(
        ...
        *,
        ...
        if not revision_id:
            raise ValueError(f"Expected a non-empty value for `revision_id` but received {revision_id!r}")
        return self._post(
            f"/cms/v3/pages/site-pages/{object_id}/revisions/{revision_id}/restore",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=Page,
    ...
    def restore_revision_to_draft(
        ...
        *,
        ...
        if not object_id:
            raise ValueError(f"Expected a non-empty value for `object_id` but received {object_id!r}")
        return self._post(
            f"/cms/v3/pages/site-pages/{object_id}/revisions/{revision_id}/restore-to-draft",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=Page,
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                site_page_schedule_params.SitePageScheduleParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def set_new_lang_primary(
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform({"id": id}, site_page_set_new_lang_primary_params.SitePageSetNewLangPrimaryParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def update_batch(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"inputs": inputs}, site_page_update_batch_params.SitePageUpdateBatchParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"archived": archived}, site_page_update_batch_params.SitePageUpdateBatchParams),
            ),
            cast_to=BatchResponsePage,
        )
        ...
        *,
        ...
        return self._patch(
            ...
            body=maybe_transform(
                ...
                site_page_update_draft_params.SitePageUpdateDraftParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                site_page_update_languages_params.SitePageUpdateLanguagesParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncSitePagesResource(AsyncAPIResource):
        ...
        *,
        ...
        return await self._patch(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"archived": archived}, site_page_update_params.SitePageUpdateParams),
            ),
            cast_to=Page,
        )
        ...
        *,
        ...
        return await self._delete(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"archived": archived}, site_page_delete_params.SitePageDeleteParams),
            ),
            cast_to=NoneType,
        )
    ...
    async def create_batch(
        ...
        *,
        ...
        return await self._post(
            "/cms/v3/pages/site-pages/batch/create",
            body=await async_maybe_transform(
                {"inputs": inputs}, site_page_create_batch_params.SitePageCreateBatchParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def delete_batch(
        ...
        *,
        ...
        return await self._post(
            "/cms/v3/pages/site-pages/batch/archive",
            body=await async_maybe_transform(
                {"inputs": inputs}, site_page_delete_batch_params.SitePageDeleteBatchParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def detach_from_lang_group(
        ...
        *,
        ...
        return await self._post(
            "/cms/v3/pages/site-pages/multi-language/detach-from-lang-group",
            body=await async_maybe_transform(
                {"id": id}, site_page_detach_from_lang_group_params.SitePageDetachFromLangGroupParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def get_batch(
        ...
        *,
        ...
        return await self._post(
            "/cms/v3/pages/site-pages/batch/read",
            body=await async_maybe_transform({"inputs": inputs}, site_page_get_batch_params.SitePageGetBatchParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform(
                    {"archived": archived}, site_page_get_batch_params.SitePageGetBatchParams
                ),
            ),
            cast_to=BatchResponsePage,
        )
    ...
    async def set_new_lang_primary(
        ...
        *,
        ...
        return await self._put(
            "/cms/v3/pages/site-pages/multi-language/set-new-lang-primary",
            body=await async_maybe_transform(
                {"id": id}, site_page_set_new_lang_primary_params.SitePageSetNewLangPrimaryParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def update_batch(
        ...
        *,
        ...
        return await self._post(
            "/cms/v3/pages/site-pages/batch/update",
            body=await async_maybe_transform(
                {"inputs": inputs}, site_page_update_batch_params.SitePageUpdateBatchParams
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                ...
                timeout=timeout,
                query=await async_maybe_transform(
                    {"archived": archived}, site_page_update_batch_params.SitePageUpdateBatchParams
                ),
            ),
            cast_to=BatchResponsePage,
        )
...
class SitePagesResourceWithRawResponse:
    def __init__(self, site_pages: SitePagesResource) -> None:
        self._site_pages = site_pages
