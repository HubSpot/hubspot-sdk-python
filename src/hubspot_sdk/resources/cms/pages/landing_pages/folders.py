...
from .....types.cms.pages.landing_pages import (
    ...
    folder_create_folders_params,
    folder_delete_folders_params,
    folder_list_revisions_params,
    folder_update_folders_params,
)
    ...
    def create_folders(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"inputs": inputs}, folder_create_folders_params.FolderCreateFoldersParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResponseContentFolder,
    ...
    def delete_folders(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"inputs": inputs}, folder_delete_folders_params.FolderDeleteFoldersParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def update_folders(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"inputs": inputs}, folder_update_folders_params.FolderUpdateFoldersParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"archived": archived}, folder_update_folders_params.FolderUpdateFoldersParams),
            ),
            cast_to=BatchResponseContentFolder,
        )
    ...
    async def create_folders(
        ...
        *,
        ...
        return await self._post(
            "/cms/pages/2026-03/landing-pages/folders/batch/create",
            body=await async_maybe_transform(
                {"inputs": inputs}, folder_create_folders_params.FolderCreateFoldersParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def delete_folders(
        ...
        *,
        ...
        return await self._post(
            "/cms/pages/2026-03/landing-pages/folders/batch/archive",
            body=await async_maybe_transform(
                {"inputs": inputs}, folder_delete_folders_params.FolderDeleteFoldersParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def update_folders(
        ...
        *,
        ...
        return await self._post(
            "/cms/pages/2026-03/landing-pages/folders/batch/update",
            body=await async_maybe_transform(
                {"inputs": inputs}, folder_update_folders_params.FolderUpdateFoldersParams
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                ...
                timeout=timeout,
                query=await async_maybe_transform(
                    {"archived": archived}, folder_update_folders_params.FolderUpdateFoldersParams
                ),
            ),
            cast_to=BatchResponseContentFolder,
        )
