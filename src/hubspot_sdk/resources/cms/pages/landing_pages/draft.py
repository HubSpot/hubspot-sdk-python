...
from .....types.cms.pages.landing_pages import draft_update_params
...
class DraftResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template("/cms/pages/2026-03/landing-pages/{object_id}/draft", object_id=object_id),
    ...
    def push_live(
        ...
        *,
        ...
        return self._post(
            path_template("/cms/pages/2026-03/landing-pages/{object_id}/draft/push-live", object_id=object_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def reset(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            path_template("/cms/pages/2026-03/landing-pages/{object_id}/draft/reset", object_id=object_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
