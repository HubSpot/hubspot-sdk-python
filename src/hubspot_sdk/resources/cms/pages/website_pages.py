...
from ....types.cms.pages import (
    ...
    website_page_clone_params,
    website_page_create_params,
    website_page_delete_params,
    website_page_update_params,
    website_page_schedule_params,
...
__all__ = ["WebsitePagesResource", "AsyncWebsitePagesResource"]


class WebsitePagesResource(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> WebsitePagesResourceWithRawResponse:
        """
        ...
        """
        return WebsitePagesResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> WebsitePagesResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/HubSpot/hubspot-sdk-python#with_streaming_response
        """
        return WebsitePagesResourceWithStreamingResponse(self)
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                website_page_create_params.WebsitePageCreateParams,
            ),
        ...
        *,
        ...
        return self._patch(
            ...
            body=maybe_transform(
                ...
                website_page_update_params.WebsitePageUpdateParams,
            ),
            options=make_request_options(
        ...
        *,
        ...
        return self._delete(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"archived": archived}, website_page_delete_params.WebsitePageDeleteParams),
            ),
            cast_to=NoneType,
        )
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                website_page_clone_params.WebsitePageCloneParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                website_page_schedule_params.WebsitePageScheduleParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def set_new_lang_primary(
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                {"id": id}, website_page_set_new_lang_primary_params.WebsitePageSetNewLangPrimaryParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._patch(
            ...
            body=maybe_transform(
                ...
                website_page_update_draft_params.WebsitePageUpdateDraftParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncWebsitePagesResource(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncWebsitePagesResourceWithRawResponse:
        """
        This property can be used as a prefix for any HTTP method call to return
        the raw response object instead of the parsed content.
        ...
        For more information, see https://www.github.com/HubSpot/hubspot-sdk-python#accessing-raw-response-data-eg-headers
        """
        return AsyncWebsitePagesResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncWebsitePagesResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/HubSpot/hubspot-sdk-python#with_streaming_response
        """
        return AsyncWebsitePagesResourceWithStreamingResponse(self)
        ...
        *,
        ...
        return await self._delete(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=await async_maybe_transform(
                    {"archived": archived}, website_page_delete_params.WebsitePageDeleteParams
                ),
            ),
            cast_to=NoneType,
        )
...
class WebsitePagesResourceWithRawResponse:
    def __init__(self, website_pages: WebsitePagesResource) -> None:
        ...
        self.get_draft = to_raw_response_wrapper(
            website_pages.get_draft,
        )
        self.publish_draft = to_raw_response_wrapper(
            website_pages.publish_draft,
        )
        self.schedule = to_raw_response_wrapper(
            website_pages.schedule,
        )
        self.set_new_lang_primary = to_raw_response_wrapper(
            website_pages.set_new_lang_primary,
        )
        self.update_draft = to_raw_response_wrapper(
            website_pages.update_draft,
        )


class AsyncWebsitePagesResourceWithRawResponse:
    def __init__(self, website_pages: AsyncWebsitePagesResource) -> None:
        self._website_pages = website_pages
...
class WebsitePagesResourceWithStreamingResponse:
    def __init__(self, website_pages: WebsitePagesResource) -> None:
        self._website_pages = website_pages
...
class AsyncWebsitePagesResourceWithStreamingResponse:
    def __init__(self, website_pages: AsyncWebsitePagesResource) -> None:
        self._website_pages = website_pages
