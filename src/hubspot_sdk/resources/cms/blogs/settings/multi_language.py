...
from .....types.cms.blogs.settings import (
    multi_language_update_languages_params,
    multi_language_attach_to_lang_group_params,
    multi_language_set_new_lang_primary_params,
...
class MultiLanguageResource(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> MultiLanguageResourceWithRawResponse:
        """
        ...
        """
        return MultiLanguageResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> MultiLanguageResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/HubSpot/hubspot-sdk-python#with_streaming_response
        """
        return MultiLanguageResourceWithStreamingResponse(self)
    ...
    def attach_to_lang_group(
        ...
        *,
        ...
        return self._post(
            "/cms/blog-settings/2026-03/settings/multi-language/attach-to-lang-group",
            body=maybe_transform(
                ...
                multi_language_attach_to_lang_group_params.MultiLanguageAttachToLangGroupParams,
            ),
    ...
    def create_language_variation(
        ...
        *,
        ...
        """
        return self._post(
            "/cms/blog-settings/2026-03/settings/multi-language/create-language-variation",
            body=maybe_transform(
                {
                    "id": id,
                    "language": language,
    ...
    def detach_from_lang_group(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            "/cms/blog-settings/2026-03/settings/multi-language/detach-from-lang-group",
            body=maybe_transform(
                {"id": id}, multi_language_detach_from_lang_group_params.MultiLanguageDetachFromLangGroupParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def set_new_lang_primary(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._put(
            "/cms/blog-settings/2026-03/settings/multi-language/set-new-lang-primary",
            body=maybe_transform(
                {"id": id}, multi_language_set_new_lang_primary_params.MultiLanguageSetNewLangPrimaryParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def update_languages(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            "/cms/blog-settings/2026-03/settings/multi-language/update-languages",
            body=maybe_transform(
                {
                    "languages": languages,
                    "primary_id": primary_id,
                },
                multi_language_update_languages_params.MultiLanguageUpdateLanguagesParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncMultiLanguageResource(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncMultiLanguageResourceWithRawResponse:
        """
        This property can be used as a prefix for any HTTP method call to return
        the raw response object instead of the parsed content.
        ...
        For more information, see https://www.github.com/HubSpot/hubspot-sdk-python#accessing-raw-response-data-eg-headers
        """
        return AsyncMultiLanguageResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncMultiLanguageResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/HubSpot/hubspot-sdk-python#with_streaming_response
        """
        return AsyncMultiLanguageResourceWithStreamingResponse(self)
...
class MultiLanguageResourceWithRawResponse:
    def __init__(self, multi_language: MultiLanguageResource) -> None:
        self._multi_language = multi_language

        self.attach_to_lang_group = to_custom_raw_response_wrapper(
            multi_language.attach_to_lang_group,
            BinaryAPIResponse,
        )
        self.create_language_variation = to_raw_response_wrapper(
            multi_language.create_language_variation,
        )
        self.detach_from_lang_group = to_custom_raw_response_wrapper(
            multi_language.detach_from_lang_group,
            BinaryAPIResponse,
        )
        self.set_new_lang_primary = to_raw_response_wrapper(
            multi_language.set_new_lang_primary,
        )
        self.update_languages = to_custom_raw_response_wrapper(
            multi_language.update_languages,
            BinaryAPIResponse,
        )


class AsyncMultiLanguageResourceWithRawResponse:
    def __init__(self, multi_language: AsyncMultiLanguageResource) -> None:
        self._multi_language = multi_language
...
class MultiLanguageResourceWithStreamingResponse:
    def __init__(self, multi_language: MultiLanguageResource) -> None:
        self._multi_language = multi_language
...
class AsyncMultiLanguageResourceWithStreamingResponse:
    def __init__(self, multi_language: AsyncMultiLanguageResource) -> None:
        self._multi_language = multi_language
