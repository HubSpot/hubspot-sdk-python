...
from .....types.cms.blogs.posts import (
    multi_language_update_langs_params,
    multi_language_set_lang_primary_params,
    multi_language_attach_to_lang_group_params,
    multi_language_create_lang_variation_params,
    ...
    def set_lang_primary(
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform({"id": id}, multi_language_set_lang_primary_params.MultiLanguageSetLangPrimaryParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                multi_language_update_langs_params.MultiLanguageUpdateLangsParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def set_lang_primary(
        ...
        *,
        ...
        return await self._put(
            "/cms/blogs/2026-03/posts/multi-language/set-new-lang-primary",
            body=await async_maybe_transform(
                {"id": id}, multi_language_set_lang_primary_params.MultiLanguageSetLangPrimaryParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class MultiLanguageResourceWithRawResponse:
    def __init__(self, multi_language: MultiLanguageResource) -> None:
        ...
        self.create_lang_variation = to_custom_raw_response_wrapper(
            multi_language.create_lang_variation,
            BinaryAPIResponse,
        )
        ...
        self.set_lang_primary = to_raw_response_wrapper(
            multi_language.set_lang_primary,
        )
        self.update_langs = to_custom_raw_response_wrapper(
            multi_language.update_langs,
            BinaryAPIResponse,
        )
