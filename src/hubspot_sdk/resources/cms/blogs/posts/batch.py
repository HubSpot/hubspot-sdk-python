...
class BatchResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            "/cms/blogs/2026-03/posts/batch/create",
    ...
    def update(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            "/cms/blogs/2026-03/posts/batch/update",
    ...
    def delete(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            "/cms/blogs/2026-03/posts/batch/archive",
    ...
    def get(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            "/cms/blogs/2026-03/posts/batch/read",
