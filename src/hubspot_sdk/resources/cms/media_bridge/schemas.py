...
from ....types.cms.media_bridge.schema_create_association_response import SchemaCreateAssociationResponse
...
class SchemasResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            f"/media-bridge/v1/{app_id}/schemas/{object_type}",
    ...
    def create_association(
        ...
        *,
        ...
        if not object_type:
            raise ValueError(f"Expected a non-empty value for `object_type` but received {object_type!r}")
        return self._post(
            f"/media-bridge/v1/{app_id}/schemas/{object_type}/associations",
            body=maybe_transform(
                {
    ...
    def delete_association(
        ...
        *,
        ...
        return self._delete(
            f"/media-bridge/v1/{app_id}/schemas/{object_type}/associations/{association_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
