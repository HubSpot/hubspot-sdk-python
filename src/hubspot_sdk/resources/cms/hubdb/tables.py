...
class TablesResource(SyncAPIResource):
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            path_template("/cms/hubdb/2026-03/tables/{table_id_or_name}", table_id_or_name=table_id_or_name),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def clone_draft(
        ...
        *,
        ...
        Args:
          ...
          is_hubspot_defined: Indicates whether the table is defined by HubSpot.
        ...
        return self._post(
            path_template(
                "/cms/hubdb/2026-03/tables/{table_id_or_name}/draft/clone", table_id_or_name=table_id_or_name
            ),
            body=maybe_transform(
                {
                    "copy_rows": copy_rows,
    ...
    def delete_version(
        ...
        *,
        ...
        return self._delete(
            path_template(
                "/cms/hubdb/2026-03/tables/{table_id_or_name}/versions/{version_id}",
    ...
    def export(
        ...
        *,
        ...
        return self._get(
            path_template("/cms/hubdb/2026-03/tables/{table_id_or_name}/export", table_id_or_name=table_id_or_name),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
    ...
    def export_draft(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/cms/hubdb/2026-03/tables/{table_id_or_name}/draft/export", table_id_or_name=table_id_or_name
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
    ...
    def get_draft(
        ...
        *,
        ...
        if not table_id_or_name:
            raise ValueError(f"Expected a non-empty value for `table_id_or_name` but received {table_id_or_name!r}")
        return self._get(
            path_template("/cms/hubdb/2026-03/tables/{table_id_or_name}/draft", table_id_or_name=table_id_or_name),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
    ...
    def import_draft(
        ...
        *,
        ...
        return self._post(
            path_template(
                "/cms/hubdb/2026-03/tables/{table_id_or_name}/draft/import", table_id_or_name=table_id_or_name
            ),
    ...
    def publish_draft(
        ...
        *,
        ...
        return self._post(
            path_template(
                "/cms/hubdb/2026-03/tables/{table_id_or_name}/draft/publish", table_id_or_name=table_id_or_name
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
    ...
    def reset_draft(
        ...
        *,
        ...
        return self._post(
            path_template(
                "/cms/hubdb/2026-03/tables/{table_id_or_name}/draft/reset", table_id_or_name=table_id_or_name
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
    ...
    def unpublish(
        ...
        *,
        ...
        if not table_id_or_name:
            raise ValueError(f"Expected a non-empty value for `table_id_or_name` but received {table_id_or_name!r}")
        return self._post(
            path_template("/cms/hubdb/2026-03/tables/{table_id_or_name}/unpublish", table_id_or_name=table_id_or_name),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
