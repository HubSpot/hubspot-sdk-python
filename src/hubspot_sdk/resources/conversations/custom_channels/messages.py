...
class MessagesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        associate_with_contact_id: int | Omit = omit,
        ...
        """
        return self._post(
            path_template("/conversations/custom-channels/2026-03/{channel_id}/messages", channel_id=channel_id),
            body=maybe_transform(
                {
                    ...
                    "text": text,
                    "timestamp": timestamp,
                    "associate_with_contact_id": associate_with_contact_id,
    ...
    def update(
        ...
        *,
        channel_id: int,
        status_type: Literal["FAILED", "READ", "SENT"],
        ...
        return self._patch(
            path_template(
                "/conversations/custom-channels/2026-03/{channel_id}/messages/{message_id}",
