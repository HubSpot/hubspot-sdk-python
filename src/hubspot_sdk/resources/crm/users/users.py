...
from ....types.crm import user_get_params, user_list_params, user_create_params, user_search_params, user_update_params
...
class UsersResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            f"/crm/v3/objects/users/{user_id}",
            body=maybe_transform({"properties": properties}, user_update_params.UserUpdateParams),
            options=make_request_options(
    ...
    def get(
        ...
        *,
        ...
        """Read an Object identified by `{userId}`.

        `{userId}` refers to the internal
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            f"/crm/v3/objects/users/{user_id}",
            body=await async_maybe_transform({"properties": properties}, user_update_params.UserUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
...
class UsersResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._users.batch)
...
class AsyncUsersResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._users.batch)
...
class UsersResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._users.batch)
...
class AsyncUsersResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._users.batch)
