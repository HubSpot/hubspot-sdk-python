...
class ImportsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """Begins importing data from the specified file resources.
    ...
    def cancel(
        ...
        *,
        ...
        """
        return self._post(
            f"/crm/v3/imports/{import_id}/cancel",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def list_errors(
        ...
        *,
        ...
        Args:
          ...
          include_error_message: Set to True to receive a message explaining the error.

          include_row_data: Set to True to receive the data values for the errored row.
