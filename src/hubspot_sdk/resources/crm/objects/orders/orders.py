...
class OrdersResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template("/crm/objects/2026-03/orders/{order_id}", order_id=order_id),
            body=maybe_transform({"properties": properties}, order_update_params.OrderUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, order_update_params.OrderUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
    ...
    def get(
        ...
        *,
        ...
        """Read an Object identified by `{orderId}`.

        `{orderId}` refers to the internal
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/orders/{order_id}", order_id=order_id),
            body=await async_maybe_transform({"properties": properties}, order_update_params.OrderUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"id_property": id_property}, order_update_params.OrderUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
...
class OrdersResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._orders.batch)
...
class AsyncOrdersResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._orders.batch)
...
class OrdersResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._orders.batch)
...
class AsyncOrdersResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._orders.batch)
