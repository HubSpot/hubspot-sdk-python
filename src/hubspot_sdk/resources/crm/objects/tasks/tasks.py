...
class TasksResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template("/crm/objects/2026-03/tasks/{task_id}", task_id=task_id),
            body=maybe_transform({"properties": properties}, task_update_params.TaskUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, task_update_params.TaskUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/tasks/search",
            body=maybe_transform(
                {
                    "after": after,
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/tasks/{task_id}", task_id=task_id),
            body=await async_maybe_transform({"properties": properties}, task_update_params.TaskUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"id_property": id_property}, task_update_params.TaskUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
