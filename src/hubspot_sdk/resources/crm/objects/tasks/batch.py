...
from .....types.crm.objects.tasks import (
    batch_get_params,
    batch_create_params,
    batch_delete_params,
    batch_update_params,
...
class BatchResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/tasks/batch/create",
    ...
    def update(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/tasks/batch/update",
    ...
    def delete(
        ...
        *,
        ...
        return self._post(
            "/crm/objects/2026-03/tasks/batch/archive",
    ...
    def get(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/tasks/batch/read",
    ...
    def upsert(
        ...
        *,
        ...
        """Create and update a batch of tasks by a unique property.
        ...
        """
        return self._post(
            "/crm/objects/2026-03/tasks/batch/upsert",
