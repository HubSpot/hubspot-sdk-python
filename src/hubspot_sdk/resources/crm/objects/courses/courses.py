...
class CoursesResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        """
        if not course_id:
            raise ValueError(f"Expected a non-empty value for `course_id` but received {course_id!r}")
        return self._patch(
            path_template("/crm/objects/2026-03/0-410/{course_id}", course_id=course_id),
            body=maybe_transform({"properties": properties}, course_update_params.CourseUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, course_update_params.CourseUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
    ...
    def get(
        ...
        *,
        ...
        """Read an Object identified by `{courseId}`.

        `{courseId}` refers to the internal
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    course_get_params.CourseGetParams,
                ),
            ),
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/0-410/search",
            body=maybe_transform(
                {
                    "after": after,
                ...
                course_search_params.CourseSearchParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/0-410/{course_id}", course_id=course_id),
            body=await async_maybe_transform({"properties": properties}, course_update_params.CourseUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=await async_maybe_transform(
                    {"id_property": id_property}, course_update_params.CourseUpdateParams
                ),
            ),
            cast_to=SimplePublicObject,
        )
...
class CoursesResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._courses.batch)
...
class AsyncCoursesResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._courses.batch)
...
class CoursesResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._courses.batch)
...
class AsyncCoursesResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._courses.batch)
