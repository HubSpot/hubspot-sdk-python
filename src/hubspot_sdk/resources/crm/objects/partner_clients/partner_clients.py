...
class PartnerClientsResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            f"/crm/v3/objects/partner_clients/{partner_client_id}",
...
class PartnerClientsResourceWithRawResponse:
    ...
    def associations(self) -> AssociationsResourceWithRawResponse:
        return AssociationsResourceWithRawResponse(self._partner_clients.associations)
...
class AsyncPartnerClientsResourceWithRawResponse:
    ...
    def associations(self) -> AsyncAssociationsResourceWithRawResponse:
        return AsyncAssociationsResourceWithRawResponse(self._partner_clients.associations)
...
class PartnerClientsResourceWithStreamingResponse:
    ...
    def associations(self) -> AssociationsResourceWithStreamingResponse:
        return AssociationsResourceWithStreamingResponse(self._partner_clients.associations)
...
class AsyncPartnerClientsResourceWithStreamingResponse:
    ...
    def associations(self) -> AsyncAssociationsResourceWithStreamingResponse:
        return AsyncAssociationsResourceWithStreamingResponse(self._partner_clients.associations)
