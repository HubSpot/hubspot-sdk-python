...
from .....types.crm.objects.partner_clients import association_list_params
...
class AssociationsResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            f"/crm/v3/objects/partner_clients/{partner_client_id}/associations/{to_object_type}/{to_object_id}/{association_type}",
    ...
    def list(
        ...
        *,
        ...
        return self._get_api_list(
            f"/crm/v3/objects/partner_clients/{partner_client_id}/associations/{to_object_type}",
