...
from .....types.crm.objects.appointments import (
    batch_get_params,
    batch_create_params,
    batch_delete_params,
    batch_update_params,
...
class BatchResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/v3/objects/0-421/batch/create",
    ...
    def update(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/v3/objects/0-421/batch/update",
    ...
    def delete(
        ...
        *,
        ...
        return self._post(
            "/crm/v3/objects/0-421/batch/archive",
    ...
    def upsert(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/v3/objects/0-421/batch/upsert",
