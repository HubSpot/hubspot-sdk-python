...
class QuotesResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template("/crm/objects/2026-03/quotes/{quote_id}", quote_id=quote_id),
            body=maybe_transform({"properties": properties}, quote_update_params.QuoteUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, quote_update_params.QuoteUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
    ...
    def get(
        ...
        *,
        ...
        `{quoteId}` refers to the internal
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                quote_search_params.QuoteSearchParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/quotes/{quote_id}", quote_id=quote_id),
            body=await async_maybe_transform({"properties": properties}, quote_update_params.QuoteUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"id_property": id_property}, quote_update_params.QuoteUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
