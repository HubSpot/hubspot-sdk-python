...
class PartnerServicesResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            f"/crm/v3/objects/partner_services/{partner_service_id}",
    ...
    def list(
        ...
        *,
        ...
        """Read a page of partner services.
        ...
        return self._get_api_list(
            "/crm/v3/objects/partner_services",
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/v3/objects/partner_services/search",
...
class PartnerServicesResourceWithRawResponse:
    ...
    def associations(self) -> AssociationsResourceWithRawResponse:
        return AssociationsResourceWithRawResponse(self._partner_services.associations)
...
class AsyncPartnerServicesResourceWithRawResponse:
    ...
    def associations(self) -> AsyncAssociationsResourceWithRawResponse:
        return AsyncAssociationsResourceWithRawResponse(self._partner_services.associations)
...
class PartnerServicesResourceWithStreamingResponse:
    ...
    def associations(self) -> AssociationsResourceWithStreamingResponse:
        return AssociationsResourceWithStreamingResponse(self._partner_services.associations)
...
class AsyncPartnerServicesResourceWithStreamingResponse:
    ...
    def associations(self) -> AsyncAssociationsResourceWithStreamingResponse:
        return AsyncAssociationsResourceWithStreamingResponse(self._partner_services.associations)
