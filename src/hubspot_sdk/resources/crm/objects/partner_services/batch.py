...
from .....types.crm.objects.partner_services import batch_get_params, batch_update_params
...
class BatchResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/v3/objects/partner_services/batch/update",
    ...
    def get(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/v3/objects/partner_services/batch/read",
