...
class SubscriptionsResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template("/crm/objects/2026-03/subscriptions/{subscription_id}", subscription_id=subscription_id),
            body=maybe_transform({"properties": properties}, subscription_update_params.SubscriptionUpdateParams),
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"id_property": id_property}, subscription_update_params.SubscriptionUpdateParams
                ),
            ),
            cast_to=SimplePublicObject,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    subscription_get_params.SubscriptionGetParams,
                ),
            ),
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/subscriptions/search",
            body=maybe_transform(
                {
                    "after": after,
                ...
                subscription_search_params.SubscriptionSearchParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/subscriptions/{subscription_id}", subscription_id=subscription_id),
            body=await async_maybe_transform(
                {"properties": properties}, subscription_update_params.SubscriptionUpdateParams
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
...
class SubscriptionsResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._subscriptions.batch)
...
class AsyncSubscriptionsResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._subscriptions.batch)
...
class SubscriptionsResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._subscriptions.batch)
...
class AsyncSubscriptionsResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._subscriptions.batch)
