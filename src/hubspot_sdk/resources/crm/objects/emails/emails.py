...
class EmailsResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template("/crm/objects/2026-03/emails/{email_id}", email_id=email_id),
            body=maybe_transform({"properties": properties}, email_update_params.EmailUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, email_update_params.EmailUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                email_search_params.EmailSearchParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/emails/{email_id}", email_id=email_id),
            body=await async_maybe_transform({"properties": properties}, email_update_params.EmailUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"id_property": id_property}, email_update_params.EmailUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
...
class EmailsResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._emails.batch)
...
class AsyncEmailsResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._emails.batch)
...
class EmailsResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._emails.batch)
...
class AsyncEmailsResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._emails.batch)
