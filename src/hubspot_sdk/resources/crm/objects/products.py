...
class ProductsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/products/batch/create",
            body=maybe_transform({"inputs": inputs}, product_create_params.ProductCreateParams),
    ...
    def update(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/products/batch/update",
            body=maybe_transform({"inputs": inputs}, product_update_params.ProductUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResponseSimplePublicObject,
    ...
    def delete(
        ...
        *,
        ...
        return self._post(
            "/crm/objects/2026-03/products/batch/archive",
            body=maybe_transform({"inputs": inputs}, product_delete_params.ProductDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def get(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/products/batch/read",
            body=maybe_transform(
                ...
                product_get_params.ProductGetParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"archived": archived}, product_get_params.ProductGetParams),
            ),
            cast_to=BatchResponseSimplePublicObject,
        )
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/products/search",
            body=maybe_transform(
                {
                    "after": after,
    ...
    def upsert(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/products/batch/upsert",
            body=maybe_transform({"inputs": inputs}, product_upsert_params.ProductUpsertParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncProductsResource(AsyncAPIResource):
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/crm/objects/2026-03/products/batch/create",
            body=await async_maybe_transform({"inputs": inputs}, product_create_params.ProductCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResponseSimplePublicObject,
    ...
    async def update(
        ...
        *,
        ...
        return await self._post(
            "/crm/objects/2026-03/products/batch/update",
            body=await async_maybe_transform({"inputs": inputs}, product_update_params.ProductUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResponseSimplePublicObject,
    ...
    async def delete(
        ...
        *,
        ...
        return await self._post(
            "/crm/objects/2026-03/products/batch/archive",
            body=await async_maybe_transform({"inputs": inputs}, product_delete_params.ProductDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
        ...
        *,
        ...
        return await self._post(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"archived": archived}, product_get_params.ProductGetParams),
            ),
            cast_to=BatchResponseSimplePublicObject,
        )
    ...
    async def upsert(
        ...
        *,
        ...
        return await self._post(
            "/crm/objects/2026-03/products/batch/upsert",
            body=await async_maybe_transform({"inputs": inputs}, product_upsert_params.ProductUpsertParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResponseSimplePublicUpsertObject,
