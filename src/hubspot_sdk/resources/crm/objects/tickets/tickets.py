...
class TicketsResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template("/crm/objects/2026-03/tickets/{ticket_id}", ticket_id=ticket_id),
            body=maybe_transform({"properties": properties}, ticket_update_params.TicketUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, ticket_update_params.TicketUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
    ...
    def get(
        ...
        *,
        ...
        `{ticketId}` refers to the internal
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    ticket_get_params.TicketGetParams,
                ),
            ),
    ...
    def merge(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/tickets/merge",
            body=maybe_transform(
                {
                    "object_id_to_merge": object_id_to_merge,
                    "primary_object_id": primary_object_id,
                },
                ticket_merge_params.TicketMergeParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/tickets/search",
            body=maybe_transform(
                {
                    "after": after,
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/tickets/{ticket_id}", ticket_id=ticket_id),
            body=await async_maybe_transform({"properties": properties}, ticket_update_params.TicketUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=await async_maybe_transform(
                    {"id_property": id_property}, ticket_update_params.TicketUpdateParams
                ),
            ),
            cast_to=SimplePublicObject,
        )
...
class TicketsResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._tickets.batch)
...
class AsyncTicketsResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._tickets.batch)
...
class TicketsResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._tickets.batch)
...
class AsyncTicketsResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._tickets.batch)
