...
from .....types.crm.objects.tickets import (
    batch_get_params,
    batch_create_params,
    batch_delete_params,
    batch_update_params,
...
class BatchResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/tickets/batch/create",
    ...
    def update(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/tickets/batch/update",
    ...
    def delete(
        ...
        *,
        ...
        """Delete a batch of tickets by ID.

        Deleted tickets can be restored within 90 days
        ...
        return self._post(
            "/crm/objects/2026-03/tickets/batch/archive",
    ...
    def get(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/tickets/batch/read",
    ...
    def upsert(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/tickets/batch/upsert",
