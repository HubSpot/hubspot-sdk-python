...
__all__ = ["CartsResource", "AsyncCartsResource"]


class CartsResource(SyncAPIResource):
    @cached_property
    def batch(self) -> BatchResource:
        return BatchResource(self._client)

    @cached_property
    def with_raw_response(self) -> CartsResourceWithRawResponse:
        """
        ...
        """
        return CartsResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> CartsResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/HubSpot/hubspot-sdk-python#with_streaming_response
        """
        return CartsResourceWithStreamingResponse(self)
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                cart_create_params.CartCreateParams,
            ),
    ...
    def update(
        ...
        *,
        ...
        """
        if not cart_id:
            raise ValueError(f"Expected a non-empty value for `cart_id` but received {cart_id!r}")
        return self._patch(
            path_template("/crm/objects/2026-03/carts/{cart_id}", cart_id=cart_id),
            body=maybe_transform({"properties": properties}, cart_update_params.CartUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, cart_update_params.CartUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    cart_list_params.CartListParams,
                ),
            ),
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/carts/search",
            body=maybe_transform(
                {
                    "after": after,
                ...
                cart_search_params.CartSearchParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncCartsResource(AsyncAPIResource):
    @cached_property
    def batch(self) -> AsyncBatchResource:
        return AsyncBatchResource(self._client)

    @cached_property
    def with_raw_response(self) -> AsyncCartsResourceWithRawResponse:
        """
        This property can be used as a prefix for any HTTP method call to return
        the raw response object instead of the parsed content.
        ...
        For more information, see https://www.github.com/HubSpot/hubspot-sdk-python#accessing-raw-response-data-eg-headers
        """
        return AsyncCartsResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncCartsResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/HubSpot/hubspot-sdk-python#with_streaming_response
        """
        return AsyncCartsResourceWithStreamingResponse(self)
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/carts/{cart_id}", cart_id=cart_id),
            body=await async_maybe_transform({"properties": properties}, cart_update_params.CartUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"id_property": id_property}, cart_update_params.CartUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
...
class CartsResourceWithRawResponse:
    def __init__(self, carts: CartsResource) -> None:
        self._carts = carts
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._carts.batch)


class AsyncCartsResourceWithRawResponse:
    def __init__(self, carts: AsyncCartsResource) -> None:
        self._carts = carts
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._carts.batch)


class CartsResourceWithStreamingResponse:
    def __init__(self, carts: CartsResource) -> None:
        self._carts = carts
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._carts.batch)


class AsyncCartsResourceWithStreamingResponse:
    def __init__(self, carts: AsyncCartsResource) -> None:
        self._carts = carts
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._carts.batch)
