...
class TaxesResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        """
        if not tax_id:
            raise ValueError(f"Expected a non-empty value for `tax_id` but received {tax_id!r}")
        return self._patch(
            path_template("/crm/objects/2026-03/taxes/{tax_id}", tax_id=tax_id),
            body=maybe_transform({"properties": properties}, tax_update_params.TaxUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, tax_update_params.TaxUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
    ...
    def get(
        ...
        *,
        ...
        """Read an Object identified by `{taxId}`.

        `{taxId}` refers to the internal object
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/taxes/{tax_id}", tax_id=tax_id),
            body=await async_maybe_transform({"properties": properties}, tax_update_params.TaxUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"id_property": id_property}, tax_update_params.TaxUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
...
class TaxesResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._taxes.batch)
...
class AsyncTaxesResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._taxes.batch)
...
class TaxesResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._taxes.batch)
...
class AsyncTaxesResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._taxes.batch)
