...
class LineItemsResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template("/crm/objects/2026-03/line_items/{line_item_id}", line_item_id=line_item_id),
            body=maybe_transform({"properties": properties}, line_item_update_params.LineItemUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, line_item_update_params.LineItemUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    line_item_get_params.LineItemGetParams,
                ),
            ),
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/line_items/search",
            body=maybe_transform(
                {
                    "after": after,
                ...
                line_item_search_params.LineItemSearchParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/line_items/{line_item_id}", line_item_id=line_item_id),
            body=await async_maybe_transform({"properties": properties}, line_item_update_params.LineItemUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=await async_maybe_transform(
                    {"id_property": id_property}, line_item_update_params.LineItemUpdateParams
                ),
            ),
            cast_to=SimplePublicObject,
        )
...
class LineItemsResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._line_items.batch)
...
class AsyncLineItemsResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._line_items.batch)
...
class LineItemsResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._line_items.batch)
...
class AsyncLineItemsResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._line_items.batch)
