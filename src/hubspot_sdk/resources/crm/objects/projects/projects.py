...
class ProjectsResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            f"/crm/objects/v3/projects/{project_id}",
    ...
    def list(
        ...
        *,
        ...
        Args:
          ...
          limit: The paging cursor token of the last successfully read resource will be returned
              as the `paging.next.after` JSON property of a paged response containing more
              results.
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/v3/projects/search",
            body=maybe_transform(
                {
                    "after": after,
...
class ProjectsResourceWithRawResponse:
    ...
    def associations(self) -> AssociationsResourceWithRawResponse:
        return AssociationsResourceWithRawResponse(self._projects.associations)
...
class AsyncProjectsResourceWithRawResponse:
    ...
    def associations(self) -> AsyncAssociationsResourceWithRawResponse:
        return AsyncAssociationsResourceWithRawResponse(self._projects.associations)
...
class ProjectsResourceWithStreamingResponse:
    ...
    def associations(self) -> AssociationsResourceWithStreamingResponse:
        return AssociationsResourceWithStreamingResponse(self._projects.associations)
...
class AsyncProjectsResourceWithStreamingResponse:
    ...
    def associations(self) -> AsyncAssociationsResourceWithStreamingResponse:
        return AsyncAssociationsResourceWithStreamingResponse(self._projects.associations)
