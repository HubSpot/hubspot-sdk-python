...
from .....types.crm.objects.projects import association_list_params
...
class AssociationsResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            f"/crm/objects/v3/projects/{project_id}/associations/{to_object_type}/{to_object_id}/{association_type}",
    ...
    def list(
        ...
        *,
        ...
        return self._get_api_list(
            f"/crm/objects/v3/projects/{project_id}/associations/{to_object_type}",
