...
class ContractsResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            f"/crm/v3/objects/contracts/{contract_id}",
    ...
    def get(
        ...
        *,
        ...
        """Read an Object identified by `{contractId}`.

        `{contractId}` refers to the
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    contract_get_params.ContractGetParams,
                ),
            ),
...
class ContractsResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._contracts.batch)
...
class AsyncContractsResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._contracts.batch)
...
class ContractsResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._contracts.batch)
...
class AsyncContractsResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._contracts.batch)
