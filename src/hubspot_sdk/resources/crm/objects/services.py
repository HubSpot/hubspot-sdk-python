...
class ServicesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"inputs": inputs}, service_create_params.ServiceCreateParams),
    ...
    def update(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"inputs": inputs}, service_update_params.ServiceUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResponseSimplePublicObject,
    ...
    def delete(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"inputs": inputs}, service_delete_params.ServiceDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                service_get_params.ServiceGetParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"archived": archived}, service_get_params.ServiceGetParams),
            ),
            cast_to=BatchResponseSimplePublicObject,
        )
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/0-162/search",
            body=maybe_transform(
                {
                    "after": after,
    ...
    def upsert(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"inputs": inputs}, service_upsert_params.ServiceUpsertParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncServicesResource(AsyncAPIResource):
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/crm/objects/2026-03/0-162/batch/create",
            body=await async_maybe_transform({"inputs": inputs}, service_create_params.ServiceCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResponseSimplePublicObject,
    ...
    async def update(
        ...
        *,
        ...
        return await self._post(
            "/crm/objects/2026-03/0-162/batch/update",
            body=await async_maybe_transform({"inputs": inputs}, service_update_params.ServiceUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResponseSimplePublicObject,
    ...
    async def delete(
        ...
        *,
        ...
        return await self._post(
            "/crm/objects/2026-03/0-162/batch/archive",
            body=await async_maybe_transform({"inputs": inputs}, service_delete_params.ServiceDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
        ...
        *,
        ...
        return await self._post(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"archived": archived}, service_get_params.ServiceGetParams),
            ),
            cast_to=BatchResponseSimplePublicObject,
        )
    ...
    async def upsert(
        ...
        *,
        ...
        return await self._post(
            "/crm/objects/2026-03/0-162/batch/upsert",
            body=await async_maybe_transform({"inputs": inputs}, service_upsert_params.ServiceUpsertParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResponseSimplePublicUpsertObject,
