...
from ....types.crm.objects import (
    listing_get_params,
    listing_list_params,
    listing_create_params,
    listing_delete_params,
    listing_search_params,
    listing_update_params,
    listing_upsert_params,
)
...
__all__ = ["ListingsResource", "AsyncListingsResource"]


class ListingsResource(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> ListingsResourceWithRawResponse:
        """
        ...
        """
        return ListingsResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> ListingsResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/stainless-sdks/hubspot-sdk-python#with_streaming_response
        """
        return ListingsResourceWithStreamingResponse(self)
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/0-420/batch/create",
            body=maybe_transform({"inputs": inputs}, listing_create_params.ListingCreateParams),
    ...
    def update(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/0-420/batch/update",
            body=maybe_transform({"inputs": inputs}, listing_update_params.ListingUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResponseSimplePublicObject,
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    listing_list_params.ListingListParams,
                ),
            ),
    ...
    def delete(
        ...
        *,
        ...
        return self._post(
            "/crm/objects/2026-03/0-420/batch/archive",
            body=maybe_transform({"inputs": inputs}, listing_delete_params.ListingDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def get(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/0-420/batch/read",
            body=maybe_transform(
                ...
                listing_get_params.ListingGetParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"archived": archived}, listing_get_params.ListingGetParams),
            ),
            cast_to=BatchResponseSimplePublicObject,
        )
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/0-420/search",
            body=maybe_transform(
                {
                    "after": after,
                ...
                listing_search_params.ListingSearchParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def upsert(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/0-420/batch/upsert",
            body=maybe_transform({"inputs": inputs}, listing_upsert_params.ListingUpsertParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncListingsResource(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncListingsResourceWithRawResponse:
        """
        This property can be used as a prefix for any HTTP method call to return
        the raw response object instead of the parsed content.
        ...
        For more information, see https://www.github.com/stainless-sdks/hubspot-sdk-python#accessing-raw-response-data-eg-headers
        """
        return AsyncListingsResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncListingsResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/stainless-sdks/hubspot-sdk-python#with_streaming_response
        """
        return AsyncListingsResourceWithStreamingResponse(self)
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/crm/objects/2026-03/0-420/batch/create",
            body=await async_maybe_transform({"inputs": inputs}, listing_create_params.ListingCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResponseSimplePublicObject,
    ...
    async def update(
        ...
        *,
        ...
        return await self._post(
            "/crm/objects/2026-03/0-420/batch/update",
            body=await async_maybe_transform({"inputs": inputs}, listing_update_params.ListingUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResponseSimplePublicObject,
    ...
    async def delete(
        ...
        *,
        ...
        return await self._post(
            "/crm/objects/2026-03/0-420/batch/archive",
            body=await async_maybe_transform({"inputs": inputs}, listing_delete_params.ListingDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
        ...
        *,
        ...
        return await self._post(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"archived": archived}, listing_get_params.ListingGetParams),
            ),
            cast_to=BatchResponseSimplePublicObject,
        )
    ...
    async def upsert(
        ...
        *,
        ...
        return await self._post(
            "/crm/objects/2026-03/0-420/batch/upsert",
            body=await async_maybe_transform({"inputs": inputs}, listing_upsert_params.ListingUpsertParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResponseSimplePublicUpsertObject,
...
class ListingsResourceWithRawResponse:
    def __init__(self, listings: ListingsResource) -> None:
...
class AsyncListingsResourceWithRawResponse:
    def __init__(self, listings: AsyncListingsResource) -> None:
        self._listings = listings
...
class ListingsResourceWithStreamingResponse:
    def __init__(self, listings: ListingsResource) -> None:
        self._listings = listings
...
class AsyncListingsResourceWithStreamingResponse:
    def __init__(self, listings: AsyncListingsResource) -> None:
        self._listings = listings
