...
from .....types.crm.objects.meetings import (
    batch_get_params,
    batch_create_params,
    batch_delete_params,
    batch_update_params,
...
class BatchResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/meetings/batch/create",
    ...
    def update(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/meetings/batch/update",
    ...
    def delete(
        ...
        *,
        ...
        return self._post(
            "/crm/objects/2026-03/meetings/batch/archive",
    ...
    def get(
        ...
        *,
        ...
        """Retrieve multiple meetings in a single call.

        Specify meetings by ID or by
        ...
        """
        return self._post(
            "/crm/objects/2026-03/meetings/batch/read",
    ...
    def upsert(
        ...
        *,
        ...
        """Create and update a batch of meetings by a unique property.
        ...
        """
        return self._post(
            "/crm/objects/2026-03/meetings/batch/upsert",
