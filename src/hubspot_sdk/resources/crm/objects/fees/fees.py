...
class FeesResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        """
        if not fee_id:
            raise ValueError(f"Expected a non-empty value for `fee_id` but received {fee_id!r}")
        return self._patch(
            path_template("/crm/objects/2026-03/fees/{fee_id}", fee_id=fee_id),
            body=maybe_transform({"properties": properties}, fee_update_params.FeeUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, fee_update_params.FeeUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
    ...
    def get(
        ...
        *,
        ...
        """Read an Object identified by `{feeId}`.

        `{feeId}` refers to the internal object
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/fees/search",
            body=maybe_transform(
                {
                    "after": after,
                ...
                fee_search_params.FeeSearchParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/fees/{fee_id}", fee_id=fee_id),
            body=await async_maybe_transform({"properties": properties}, fee_update_params.FeeUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"id_property": id_property}, fee_update_params.FeeUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
...
class FeesResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._fees.batch)
...
class AsyncFeesResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._fees.batch)
...
class FeesResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._fees.batch)
...
class AsyncFeesResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._fees.batch)
