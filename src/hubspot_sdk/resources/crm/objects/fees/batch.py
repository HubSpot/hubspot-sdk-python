...
from .....types.crm.objects.fees import (
    batch_get_params,
    batch_create_params,
    batch_delete_params,
    batch_update_params,
...
class BatchResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/fees/batch/create",
    ...
    def update(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/fees/batch/update",
    ...
    def delete(
        ...
        *,
        ...
        return self._post(
            "/crm/objects/2026-03/fees/batch/archive",
    ...
    def get(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/fees/batch/read",
    ...
    def upsert(
        ...
        *,
        ...
        """Create and update a batch of fees by a unique property.
        ...
        """
        return self._post(
            "/crm/objects/2026-03/fees/batch/upsert",
