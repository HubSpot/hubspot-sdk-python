...
from .....types.crm.objects.invoices import (
    batch_get_params,
    batch_create_params,
    batch_delete_params,
    batch_update_params,
...
class BatchResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/invoices/batch/create",
    ...
    def update(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/invoices/batch/update",
    ...
    def delete(
        ...
        *,
        ...
        """Archive multiple invoices by their IDs in a single request.
        ...
        return self._post(
            "/crm/objects/2026-03/invoices/batch/archive",
    ...
    def get(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/invoices/batch/read",
    ...
    def upsert(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/invoices/batch/upsert",
