    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            ...
            body=maybe_transform({"properties": properties}, object_update_params.ObjectUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, object_update_params.ObjectUpdateParams),
            ),
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            f"/crm/v3/objects/{object_type}/{object_id}",
            body=await async_maybe_transform({"properties": properties}, object_update_params.ObjectUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=await async_maybe_transform(
                    {"id_property": id_property}, object_update_params.ObjectUpdateParams
                ),
            ),
            cast_to=SimplePublicObject,
        )
...
class ObjectsResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._objects.batch)
...
class AsyncObjectsResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._objects.batch)
...
class ObjectsResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._objects.batch)
...
class AsyncObjectsResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._objects.batch)
