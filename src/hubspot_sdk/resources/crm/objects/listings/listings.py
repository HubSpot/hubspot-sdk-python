...
class ListingsResource(SyncAPIResource):
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                listing_create_params.ListingCreateParams,
            ),
    ...
    def update(
        ...
        *,
        ...
        """
        if not listing_id:
            raise ValueError(f"Expected a non-empty value for `listing_id` but received {listing_id!r}")
        return self._patch(
            path_template("/crm/objects/2026-03/0-420/{listing_id}", listing_id=listing_id),
            body=maybe_transform({"properties": properties}, listing_update_params.ListingUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, listing_update_params.ListingUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
    ...
    def get(
        ...
        *,
        ...
        """Read an Object identified by `{listingId}`.

        `{listingId}` refers to the internal
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/0-420/{listing_id}", listing_id=listing_id),
            body=await async_maybe_transform({"properties": properties}, listing_update_params.ListingUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=await async_maybe_transform(
                    {"id_property": id_property}, listing_update_params.ListingUpdateParams
                ),
            ),
            cast_to=SimplePublicObject,
        )
...
class ListingsResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._listings.batch)
...
class AsyncListingsResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._listings.batch)
...
class ListingsResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._listings.batch)
...
class AsyncListingsResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._listings.batch)
