...
from .....types.crm.objects.discounts import (
    batch_get_params,
    batch_create_params,
    batch_delete_params,
    batch_update_params,
...
class BatchResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/discounts/batch/create",
    ...
    def update(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/discounts/batch/update",
    ...
    def delete(
        ...
        *,
        ...
        return self._post(
            "/crm/objects/2026-03/discounts/batch/archive",
    ...
    def get(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/discounts/batch/read",
    ...
    def upsert(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/discounts/batch/upsert",
