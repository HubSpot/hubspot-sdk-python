...
from .....types.crm.objects import (
    discount_get_params,
    discount_list_params,
    discount_create_params,
    discount_search_params,
    discount_update_params,
)
...
class DiscountsResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template("/crm/objects/2026-03/discounts/{discount_id}", discount_id=discount_id),
            body=maybe_transform({"properties": properties}, discount_update_params.DiscountUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, discount_update_params.DiscountUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    discount_get_params.DiscountGetParams,
                ),
            ),
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/discounts/search",
            body=maybe_transform(
                {
                    "after": after,
                ...
                discount_search_params.DiscountSearchParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/discounts/{discount_id}", discount_id=discount_id),
            body=await async_maybe_transform({"properties": properties}, discount_update_params.DiscountUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=await async_maybe_transform(
                    {"id_property": id_property}, discount_update_params.DiscountUpdateParams
                ),
            ),
            cast_to=SimplePublicObject,
        )
...
class DiscountsResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._discounts.batch)
...
class AsyncDiscountsResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._discounts.batch)
...
class DiscountsResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._discounts.batch)
...
class AsyncDiscountsResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._discounts.batch)
