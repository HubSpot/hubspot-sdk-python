...
from .....types.crm.objects.calls import (
    batch_get_params,
    batch_create_params,
    batch_delete_params,
    batch_update_params,
...
class BatchResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        The `inputs` array can contain a `properties` object to
        ...
        """
        return self._post(
            "/crm/objects/2026-03/calls/batch/create",
    ...
    def update(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/calls/batch/update",
    ...
    def delete(
        ...
        *,
        ...
        Deleted calls can be restored within 90 days of
        ...
        return self._post(
            "/crm/objects/2026-03/calls/batch/archive",
    ...
    def get(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/calls/batch/read",
    ...
    def upsert(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/calls/batch/upsert",
