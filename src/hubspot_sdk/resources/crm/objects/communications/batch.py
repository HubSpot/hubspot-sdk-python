...
from .....types.crm.objects.communications import (
    batch_get_params,
    batch_create_params,
    batch_delete_params,
    batch_update_params,
...
class BatchResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/communications/batch/create",
    ...
    def update(
        ...
        *,
        ...
        """
        Update a batch of communications by ID (`objectId`) or unique property value
        ...
        """
        return self._post(
            "/crm/objects/2026-03/communications/batch/update",
    ...
    def delete(
        ...
        *,
        ...
        A deleted message can be restored within 90
        ...
        return self._post(
            "/crm/objects/2026-03/communications/batch/archive",
    ...
    def get(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/communications/batch/read",
    ...
    def upsert(
        ...
        *,
        ...
        """Create and update a batch of communications by a unique property.

        Communications
        that don't exist will be created, while existing communications will be updated.
        ...
        """
        return self._post(
            "/crm/objects/2026-03/communications/batch/upsert",
