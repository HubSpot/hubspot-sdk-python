...
__all__ = ["CommunicationsResource", "AsyncCommunicationsResource"]


class CommunicationsResource(SyncAPIResource):
    @cached_property
    def batch(self) -> BatchResource:
        return BatchResource(self._client)

    @cached_property
    def with_raw_response(self) -> CommunicationsResourceWithRawResponse:
        """
        ...
        """
        return CommunicationsResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> CommunicationsResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/HubSpot/hubspot-sdk-python#with_streaming_response
        """
        return CommunicationsResourceWithStreamingResponse(self)
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                communication_create_params.CommunicationCreateParams,
            ),
    ...
    def update(
        ...
        *,
        ...
        if not communication_id:
            raise ValueError(f"Expected a non-empty value for `communication_id` but received {communication_id!r}")
        return self._patch(
            path_template("/crm/objects/2026-03/communications/{communication_id}", communication_id=communication_id),
            body=maybe_transform({"properties": properties}, communication_update_params.CommunicationUpdateParams),
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"id_property": id_property}, communication_update_params.CommunicationUpdateParams
                ),
            ),
            cast_to=SimplePublicObject,
        )
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    communication_list_params.CommunicationListParams,
                ),
            ),
    ...
    def search(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/objects/2026-03/communications/search",
            body=maybe_transform(
                {
                    "after": after,
                ...
                communication_search_params.CommunicationSearchParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncCommunicationsResource(AsyncAPIResource):
    @cached_property
    def batch(self) -> AsyncBatchResource:
        return AsyncBatchResource(self._client)

    @cached_property
    def with_raw_response(self) -> AsyncCommunicationsResourceWithRawResponse:
        """
        This property can be used as a prefix for any HTTP method call to return
        the raw response object instead of the parsed content.
        ...
        For more information, see https://www.github.com/HubSpot/hubspot-sdk-python#accessing-raw-response-data-eg-headers
        """
        return AsyncCommunicationsResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncCommunicationsResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/HubSpot/hubspot-sdk-python#with_streaming_response
        """
        return AsyncCommunicationsResourceWithStreamingResponse(self)
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/communications/{communication_id}", communication_id=communication_id),
            body=await async_maybe_transform(
                {"properties": properties}, communication_update_params.CommunicationUpdateParams
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
...
class CommunicationsResourceWithRawResponse:
    def __init__(self, communications: CommunicationsResource) -> None:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._communications.batch)


class AsyncCommunicationsResourceWithRawResponse:
    def __init__(self, communications: AsyncCommunicationsResource) -> None:
        self._communications = communications
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._communications.batch)


class CommunicationsResourceWithStreamingResponse:
    def __init__(self, communications: CommunicationsResource) -> None:
        self._communications = communications
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._communications.batch)


class AsyncCommunicationsResourceWithStreamingResponse:
    def __init__(self, communications: AsyncCommunicationsResource) -> None:
        self._communications = communications
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._communications.batch)
