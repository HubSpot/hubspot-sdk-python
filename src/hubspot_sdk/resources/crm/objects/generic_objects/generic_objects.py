...
from .....types.crm.objects import (
    generic_object_get_params,
    generic_object_list_params,
    generic_object_create_params,
    generic_object_search_params,
    generic_object_update_params,
)
...
__all__ = ["GenericObjectsResource", "AsyncGenericObjectsResource"]


class GenericObjectsResource(SyncAPIResource):
    @cached_property
    def batch(self) -> BatchResource:
        return BatchResource(self._client)

    @cached_property
    def with_raw_response(self) -> GenericObjectsResourceWithRawResponse:
        """
        ...
        """
        return GenericObjectsResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> GenericObjectsResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/stainless-sdks/hubspot-sdk-python#with_streaming_response
        """
        return GenericObjectsResourceWithStreamingResponse(self)
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                generic_object_create_params.GenericObjectCreateParams,
            ),
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            ...
            body=maybe_transform({"properties": properties}, generic_object_update_params.GenericObjectUpdateParams),
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"id_property": id_property}, generic_object_update_params.GenericObjectUpdateParams
                ),
            ),
            cast_to=SimplePublicObject,
        )
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    generic_object_list_params.GenericObjectListParams,
                ),
            ),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    generic_object_get_params.GenericObjectGetParams,
                ),
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                generic_object_search_params.GenericObjectSearchParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncGenericObjectsResource(AsyncAPIResource):
    @cached_property
    def batch(self) -> AsyncBatchResource:
        return AsyncBatchResource(self._client)

    @cached_property
    def with_raw_response(self) -> AsyncGenericObjectsResourceWithRawResponse:
        """
        This property can be used as a prefix for any HTTP method call to return
        the raw response object instead of the parsed content.
        ...
        For more information, see https://www.github.com/stainless-sdks/hubspot-sdk-python#accessing-raw-response-data-eg-headers
        """
        return AsyncGenericObjectsResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncGenericObjectsResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/stainless-sdks/hubspot-sdk-python#with_streaming_response
        """
        return AsyncGenericObjectsResourceWithStreamingResponse(self)
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            ...
            body=await async_maybe_transform(
                {"properties": properties}, generic_object_update_params.GenericObjectUpdateParams
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
...
class GenericObjectsResourceWithRawResponse:
    def __init__(self, generic_objects: GenericObjectsResource) -> None:
        self._generic_objects = generic_objects

        self.create = to_raw_response_wrapper(
            generic_objects.create,
        )
        self.update = to_raw_response_wrapper(
            generic_objects.update,
        )
        self.list = to_raw_response_wrapper(
            generic_objects.list,
        )
        self.delete = to_raw_response_wrapper(
            generic_objects.delete,
        )
        self.get = to_raw_response_wrapper(
            generic_objects.get,
        )
        self.search = to_raw_response_wrapper(
            generic_objects.search,
        )

    @cached_property
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._generic_objects.batch)


class AsyncGenericObjectsResourceWithRawResponse:
    def __init__(self, generic_objects: AsyncGenericObjectsResource) -> None:
        self._generic_objects = generic_objects
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._generic_objects.batch)


class GenericObjectsResourceWithStreamingResponse:
    def __init__(self, generic_objects: GenericObjectsResource) -> None:
        self._generic_objects = generic_objects
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._generic_objects.batch)


class AsyncGenericObjectsResourceWithStreamingResponse:
    def __init__(self, generic_objects: AsyncGenericObjectsResource) -> None:
        self._generic_objects = generic_objects
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._generic_objects.batch)
