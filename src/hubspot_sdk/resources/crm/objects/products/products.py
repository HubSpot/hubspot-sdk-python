...
class ProductsResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template("/crm/objects/2026-03/products/{product_id}", product_id=product_id),
            body=maybe_transform({"properties": properties}, product_update_params.ProductUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"id_property": id_property}, product_update_params.ProductUpdateParams),
            ),
            cast_to=SimplePublicObject,
        )
    ...
    def get(
        ...
        *,
        ...
        `{productId}` refers to the internal
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            path_template("/crm/objects/2026-03/products/{product_id}", product_id=product_id),
            body=await async_maybe_transform({"properties": properties}, product_update_params.ProductUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=await async_maybe_transform(
                    {"id_property": id_property}, product_update_params.ProductUpdateParams
                ),
            ),
            cast_to=SimplePublicObject,
        )
...
class ProductsResourceWithRawResponse:
    ...
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._products.batch)
...
class AsyncProductsResourceWithRawResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._products.batch)
...
class ProductsResourceWithStreamingResponse:
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._products.batch)
...
class AsyncProductsResourceWithStreamingResponse:
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._products.batch)
