...
from .....types.crm.extensions.calling import transcript_create_params
...
class TranscriptsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            "/crm/v3/extensions/calling/transcripts",
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            f"/crm/v3/extensions/calling/transcripts/{transcript_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
