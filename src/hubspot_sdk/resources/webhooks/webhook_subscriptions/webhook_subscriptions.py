...
from ....types.webhooks import (
    webhook_subscription_update_settings_params,
    webhook_subscription_get_journal_latest_params,
    webhook_subscription_create_crm_snapshot_params,
    webhook_subscription_create_subscription_params,
    webhook_subscription_update_subscription_params,
    webhook_subscription_get_journal_earliest_params,
    webhook_subscription_get_local_journal_latest_params,
    webhook_subscription_create_subscription_filter_params,
    webhook_subscription_get_journal_next_by_offset_params,
    webhook_subscription_get_local_journal_earliest_params,
    webhook_subscription_get_local_journal_next_by_offset_params,
)
...
from ....types.webhooks.webhook_subscription_get_subscription_filter_for_subscription_response import (
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                webhook_subscription_create_crm_snapshot_params.WebhookSubscriptionCreateCrmSnapshotParams,
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                webhook_subscription_create_subscription_params.WebhookSubscriptionCreateSubscriptionParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                webhook_subscription_create_subscription_filter_params.WebhookSubscriptionCreateSubscriptionFilterParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    webhook_subscription_get_journal_earliest_params.WebhookSubscriptionGetJournalEarliestParams,
                ),
            ),
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"install_portal_id": install_portal_id},
                    webhook_subscription_get_journal_latest_params.WebhookSubscriptionGetJournalLatestParams,
                ),
            ),
            cast_to=BinaryAPIResponse,
        )
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"install_portal_id": install_portal_id},
                    webhook_subscription_get_journal_next_by_offset_params.WebhookSubscriptionGetJournalNextByOffsetParams,
                ),
            ),
            cast_to=BinaryAPIResponse,
        )
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"install_portal_id": install_portal_id},
                    webhook_subscription_get_local_journal_earliest_params.WebhookSubscriptionGetLocalJournalEarliestParams,
                ),
            ),
            cast_to=BinaryAPIResponse,
        )
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"install_portal_id": install_portal_id},
                    webhook_subscription_get_local_journal_latest_params.WebhookSubscriptionGetLocalJournalLatestParams,
                ),
            ),
            cast_to=BinaryAPIResponse,
        )
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"install_portal_id": install_portal_id},
                    webhook_subscription_get_local_journal_next_by_offset_params.WebhookSubscriptionGetLocalJournalNextByOffsetParams,
                ),
            ),
            cast_to=BinaryAPIResponse,
        )
    ...
    def get_subscription_filter_for_subscription(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=WebhookSubscriptionGetSubscriptionFilterForSubscriptionResponse,
        )
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                webhook_subscription_update_settings_params.WebhookSubscriptionUpdateSettingsParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def update_subscription(
        ...
        *,
        ...
        return self._patch(
            ...
            body=maybe_transform(
                {"active": active},
                webhook_subscription_update_subscription_params.WebhookSubscriptionUpdateSubscriptionParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncWebhookSubscriptionsResource(AsyncAPIResource):
    ...
    async def get_local_journal_earliest(
        self,
        *,
        install_portal_id: int | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
    ...
    async def get_local_journal_latest(
        self,
        *,
        install_portal_id: int | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
    ...
    async def get_local_journal_next_by_offset(
        self,
        offset: str,
        *,
        install_portal_id: int | Omit = omit,
    ...
    async def get_subscription_filter_for_subscription(
        self,
        subscription_id: int,
        *,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
...
class WebhookSubscriptionsResourceWithRawResponse:
    def __init__(self, webhook_subscriptions: WebhookSubscriptionsResource) -> None:
        ...
        self.create_crm_snapshot = to_raw_response_wrapper(
            webhook_subscriptions.create_crm_snapshot,
        )
        self.create_journal_subscription = to_raw_response_wrapper(
            webhook_subscriptions.create_journal_subscription,
        )
        self.create_subscription = to_raw_response_wrapper(
            webhook_subscriptions.create_subscription,
        )
        self.create_subscription_filter = to_raw_response_wrapper(
            webhook_subscriptions.create_subscription_filter,
        )
        self.delete_journal_subscription = to_raw_response_wrapper(
            webhook_subscriptions.delete_journal_subscription,
        )
        self.delete_portal_subscriptions = to_raw_response_wrapper(
            webhook_subscriptions.delete_portal_subscriptions,
        )
        self.delete_settings = to_raw_response_wrapper(
            webhook_subscriptions.delete_settings,
        )
        self.delete_subscription = to_raw_response_wrapper(
            webhook_subscriptions.delete_subscription,
        )
        self.delete_subscription_filter = to_raw_response_wrapper(
            webhook_subscriptions.delete_subscription_filter,
        )
        self.get_journal_earliest = to_custom_raw_response_wrapper(
            webhook_subscriptions.get_journal_earliest,
            BinaryAPIResponse,
        )
        self.get_journal_latest = to_custom_raw_response_wrapper(
            webhook_subscriptions.get_journal_latest,
            BinaryAPIResponse,
        )
        self.get_journal_next_by_offset = to_custom_raw_response_wrapper(
            webhook_subscriptions.get_journal_next_by_offset,
            BinaryAPIResponse,
        )
        self.get_journal_status = to_raw_response_wrapper(
            webhook_subscriptions.get_journal_status,
        )
        self.get_local_journal_earliest = to_custom_raw_response_wrapper(
            webhook_subscriptions.get_local_journal_earliest,
            BinaryAPIResponse,
        )
        self.get_local_journal_latest = to_custom_raw_response_wrapper(
            webhook_subscriptions.get_local_journal_latest,
            BinaryAPIResponse,
        )
        self.get_local_journal_next_by_offset = to_custom_raw_response_wrapper(
            webhook_subscriptions.get_local_journal_next_by_offset,
            BinaryAPIResponse,
        )
        self.get_local_journal_status = to_raw_response_wrapper(
            webhook_subscriptions.get_local_journal_status,
        )
        self.get_settings = to_raw_response_wrapper(
            webhook_subscriptions.get_settings,
        )
        self.get_subscription = to_raw_response_wrapper(
            webhook_subscriptions.get_subscription,
        )
        self.get_subscription_filter = to_raw_response_wrapper(
            webhook_subscriptions.get_subscription_filter,
        )
        self.get_subscription_filter_for_subscription = to_raw_response_wrapper(
            webhook_subscriptions.get_subscription_filter_for_subscription,
        )
        self.list_journal_subscriptions = to_raw_response_wrapper(
            webhook_subscriptions.list_journal_subscriptions,
        )
        self.list_subscriptions = to_raw_response_wrapper(
            webhook_subscriptions.list_subscriptions,
        )
        self.update_settings = to_raw_response_wrapper(
            webhook_subscriptions.update_settings,
        )
        self.update_subscription = to_raw_response_wrapper(
            webhook_subscriptions.update_subscription,
        )

    @cached_property
    def batch(self) -> BatchResourceWithRawResponse:
        return BatchResourceWithRawResponse(self._webhook_subscriptions.batch)
...
class AsyncWebhookSubscriptionsResourceWithRawResponse:
    def __init__(self, webhook_subscriptions: AsyncWebhookSubscriptionsResource) -> None:
        ...
        self.get_local_journal_earliest = async_to_custom_raw_response_wrapper(
            webhook_subscriptions.get_local_journal_earliest,
            AsyncBinaryAPIResponse,
        )
        self.get_local_journal_latest = async_to_custom_raw_response_wrapper(
            webhook_subscriptions.get_local_journal_latest,
            AsyncBinaryAPIResponse,
        )
        self.get_local_journal_next_by_offset = async_to_custom_raw_response_wrapper(
            webhook_subscriptions.get_local_journal_next_by_offset,
            AsyncBinaryAPIResponse,
        )
        ...
        self.get_subscription_filter_for_subscription = async_to_raw_response_wrapper(
            webhook_subscriptions.get_subscription_filter_for_subscription,
        )
    ...
    def batch(self) -> AsyncBatchResourceWithRawResponse:
        return AsyncBatchResourceWithRawResponse(self._webhook_subscriptions.batch)
...
class WebhookSubscriptionsResourceWithStreamingResponse:
    def __init__(self, webhook_subscriptions: WebhookSubscriptionsResource) -> None:
        ...
        self.get_local_journal_earliest = to_custom_streamed_response_wrapper(
            webhook_subscriptions.get_local_journal_earliest,
            StreamedBinaryAPIResponse,
        )
        self.get_local_journal_latest = to_custom_streamed_response_wrapper(
            webhook_subscriptions.get_local_journal_latest,
            StreamedBinaryAPIResponse,
        )
        self.get_local_journal_next_by_offset = to_custom_streamed_response_wrapper(
            webhook_subscriptions.get_local_journal_next_by_offset,
            StreamedBinaryAPIResponse,
        )
        ...
        self.get_subscription_filter_for_subscription = to_streamed_response_wrapper(
            webhook_subscriptions.get_subscription_filter_for_subscription,
        )
    ...
    def batch(self) -> BatchResourceWithStreamingResponse:
        return BatchResourceWithStreamingResponse(self._webhook_subscriptions.batch)
...
class AsyncWebhookSubscriptionsResourceWithStreamingResponse:
    def __init__(self, webhook_subscriptions: AsyncWebhookSubscriptionsResource) -> None:
        ...
        self.get_local_journal_earliest = async_to_custom_streamed_response_wrapper(
            webhook_subscriptions.get_local_journal_earliest,
            AsyncStreamedBinaryAPIResponse,
        )
        self.get_local_journal_latest = async_to_custom_streamed_response_wrapper(
            webhook_subscriptions.get_local_journal_latest,
            AsyncStreamedBinaryAPIResponse,
        )
        self.get_local_journal_next_by_offset = async_to_custom_streamed_response_wrapper(
            webhook_subscriptions.get_local_journal_next_by_offset,
            AsyncStreamedBinaryAPIResponse,
        )
        ...
        self.get_subscription_filter_for_subscription = async_to_streamed_response_wrapper(
            webhook_subscriptions.get_subscription_filter_for_subscription,
        )
    ...
    def batch(self) -> AsyncBatchResourceWithStreamingResponse:
        return AsyncBatchResourceWithStreamingResponse(self._webhook_subscriptions.batch)
