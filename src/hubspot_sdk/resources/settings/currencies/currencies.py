...
from ....types.settings import (
    ...
    currency_list_exchange_rates_params,
    ...
    def list_exchange_rates(
        ...
        *,
        ...
        Args:
          ...
          from_currency_code: Filters the response to only include exchange rates set from the specified
              currency.

          limit: The maximum number of results to display per page.

          to_currency_code: Filters the response to only include exchange rates set to the specified
              currency.
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    currency_list_exchange_rates_params.CurrencyListExchangeRatesParams,
                ),
            ),
            model=ExchangeRate,
        )
