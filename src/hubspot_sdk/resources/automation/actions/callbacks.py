    ...
    def complete(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"output_fields": output_fields}, callback_complete_params.CallbackCompleteParams),
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"output_fields": output_fields}, callback_complete_params.CallbackCompleteParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
