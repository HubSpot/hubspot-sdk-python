    ...
    def list(
        ...
        *,
        ...
        Args:
          ...
          name: A filter to return campaigns whose names contain the specified substring. This
...
class CampaignsResourceWithRawResponse:
    ...
    def reports(self) -> ReportsResourceWithRawResponse:
        return ReportsResourceWithRawResponse(self._campaigns.reports)
...
class AsyncCampaignsResourceWithRawResponse:
    ...
    def reports(self) -> AsyncReportsResourceWithRawResponse:
        return AsyncReportsResourceWithRawResponse(self._campaigns.reports)
...
class CampaignsResourceWithStreamingResponse:
    ...
    def reports(self) -> ReportsResourceWithStreamingResponse:
        return ReportsResourceWithStreamingResponse(self._campaigns.reports)
...
class AsyncCampaignsResourceWithStreamingResponse:
    ...
    def reports(self) -> AsyncReportsResourceWithStreamingResponse:
        return AsyncReportsResourceWithStreamingResponse(self._campaigns.reports)
