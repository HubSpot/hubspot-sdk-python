...
from ....types.marketing import (
    ...
    marketing_event_cancel_by_external_event_id_params,
    ...
    marketing_event_complete_by_external_event_id_params,
    marketing_event_upsert_subscriber_state_by_id_params,
    marketing_event_upsert_subscriber_state_by_email_params,
        ...
        *,
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"external_account_id": external_account_id},
                    marketing_event_cancel_by_external_event_id_params.MarketingEventCancelByExternalEventIDParams,
                ),
            ),
            cast_to=MarketingEventDefaultResponse,
        )
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                marketing_event_complete_by_external_event_id_params.MarketingEventCompleteByExternalEventIDParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
    ...
    def upsert_subscriber_state_by_email(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                {"inputs": inputs},
                marketing_event_upsert_subscriber_state_by_email_params.MarketingEventUpsertSubscriberStateByEmailParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
    ...
    def upsert_subscriber_state_by_id(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                {"inputs": inputs},
                marketing_event_upsert_subscriber_state_by_id_params.MarketingEventUpsertSubscriberStateByIDParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
...
class MarketingEventsResourceWithRawResponse:
    def __init__(self, marketing_events: MarketingEventsResource) -> None:
        ...
        self.cancel_by_external_event_id = to_raw_response_wrapper(
            marketing_events.cancel_by_external_event_id,
        )
        self.complete_by_external_event_id = to_raw_response_wrapper(
            marketing_events.complete_by_external_event_id,
        )
        ...
        self.upsert_subscriber_state_by_email = to_custom_raw_response_wrapper(
            marketing_events.upsert_subscriber_state_by_email,
            BinaryAPIResponse,
        )
        self.upsert_subscriber_state_by_id = to_custom_raw_response_wrapper(
            marketing_events.upsert_subscriber_state_by_id,
            BinaryAPIResponse,
        )

    @cached_property
    def associations(self) -> AssociationsResourceWithRawResponse:
        return AssociationsResourceWithRawResponse(self._marketing_events.associations)
...
class AsyncMarketingEventsResourceWithRawResponse:
    ...
    def associations(self) -> AsyncAssociationsResourceWithRawResponse:
        return AsyncAssociationsResourceWithRawResponse(self._marketing_events.associations)
...
class MarketingEventsResourceWithStreamingResponse:
    ...
    def associations(self) -> AssociationsResourceWithStreamingResponse:
        return AssociationsResourceWithStreamingResponse(self._marketing_events.associations)
...
class AsyncMarketingEventsResourceWithStreamingResponse:
    ...
    def associations(self) -> AsyncAssociationsResourceWithStreamingResponse:
        return AsyncAssociationsResourceWithStreamingResponse(self._marketing_events.associations)
