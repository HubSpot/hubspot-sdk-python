...
from ....types.marketing.marketing_events import (
    attendance_create_by_email_params,
    attendance_create_by_contact_id_params,
)
...
class AttendanceResource(SyncAPIResource):
    ...
    def create_by_contact_id(
        ...
        *,
        ...
        return self._post(
            f"/marketing/v3/marketing-events/attendance/{external_event_id}/{subscriber_state}/create",
            body=maybe_transform(
                {"inputs": inputs}, attendance_create_by_contact_id_params.AttendanceCreateByContactIDParams
            ),
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    attendance_create_by_contact_id_params.AttendanceCreateByContactIDParams,
                ),
            ),
    ...
    def create_by_email(
        ...
        *,
        ...
        if not subscriber_state:
            raise ValueError(f"Expected a non-empty value for `subscriber_state` but received {subscriber_state!r}")
        return self._post(
            f"/marketing/v3/marketing-events/attendance/{external_event_id}/{subscriber_state}/email-create",
            body=maybe_transform({"inputs": inputs}, attendance_create_by_email_params.AttendanceCreateByEmailParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=maybe_transform(
                    {"external_account_id": external_account_id},
                    attendance_create_by_email_params.AttendanceCreateByEmailParams,
                ),
            ),
...
class AsyncAttendanceResource(AsyncAPIResource):
    ...
    async def create_by_contact_id(
        self,
        subscriber_state: str,
        *,
        external_event_id: str,
    ...
    async def create_by_email(
        ...
        *,
        ...
        return await self._post(
            f"/marketing/v3/marketing-events/attendance/{external_event_id}/{subscriber_state}/email-create",
            body=await async_maybe_transform(
                {"inputs": inputs}, attendance_create_by_email_params.AttendanceCreateByEmailParams
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
...
class AttendanceResourceWithRawResponse:
    def __init__(self, attendance: AttendanceResource) -> None:
        ...
        self.create_by_contact_id = to_raw_response_wrapper(
            attendance.create_by_contact_id,
        )
        self.create_by_email = to_raw_response_wrapper(
            attendance.create_by_email,
        )
...
class AsyncAttendanceResourceWithRawResponse:
    def __init__(self, attendance: AsyncAttendanceResource) -> None:
        ...
        self.create_by_contact_id = async_to_raw_response_wrapper(
            attendance.create_by_contact_id,
        )
        self.create_by_email = async_to_raw_response_wrapper(
            attendance.create_by_email,
        )
...
class AttendanceResourceWithStreamingResponse:
    def __init__(self, attendance: AttendanceResource) -> None:
        ...
        self.create_by_contact_id = to_streamed_response_wrapper(
            attendance.create_by_contact_id,
        )
        self.create_by_email = to_streamed_response_wrapper(
            attendance.create_by_email,
        )
...
class AsyncAttendanceResourceWithStreamingResponse:
    def __init__(self, attendance: AsyncAttendanceResource) -> None:
        ...
        self.create_by_contact_id = async_to_streamed_response_wrapper(
            attendance.create_by_contact_id,
        )
        self.create_by_email = async_to_streamed_response_wrapper(
            attendance.create_by_email,
        )
