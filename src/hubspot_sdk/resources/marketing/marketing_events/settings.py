...
from ....types.marketing.marketing_events import setting_create_or_update_params
...
class SettingsResource(SyncAPIResource):
    ...
    def create_or_update(
        ...
        *,
        ...
        """
        return self._post(
            path_template("/marketing/marketing-events/2026-03/{app_id}/settings", app_id=app_id),
