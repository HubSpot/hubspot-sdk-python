...
__all__ = ["ComparativeNumberPropertyOperation"]


class ComparativeNumberPropertyOperation(BaseModel):
    ...
    property_type: Literal["number-comparative"] = FieldInfo(alias="propertyType")
