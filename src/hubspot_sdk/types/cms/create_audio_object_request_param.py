...
__all__ = ["CreateAudioObjectRequestParam"]


class CreateAudioObjectRequestParam(TypedDict, total=False):
    media_type: Required[Annotated[Literal["AUDIO"], PropertyInfo(alias="mediaType")]]
