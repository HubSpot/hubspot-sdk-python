...
__all__ = ["IsPresent", "ExpressionToEvaluate", "Input"]

if TYPE_CHECKING or not PYDANTIC_V1:
    ExpressionToEvaluate = TypeAliasType(
    ...
    ExpressionToEvaluate: TypeAlias = Union[
        "ConstantBoolean",
        "ConstantNumber",
        "ConstantString",
        "BooleanPropertyVariable",
...
class IsPresent(BaseModel):
    expression_to_evaluate: ExpressionToEvaluate = FieldInfo(alias="expressionToEvaluate")
