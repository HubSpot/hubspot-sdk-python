...
class AuthorCreateParams(TypedDict, total=False):
    ...
    (This appears to be a shorter or alternative name field compared to fullName.)
    """
    ...
    This will be normalized into the Twitter url for said user.
    """
