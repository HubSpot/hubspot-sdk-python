...
__all__ = ["CreateOtherObjectRequestParam"]


class CreateOtherObjectRequestParam(TypedDict, total=False):
    media_type: Required[Annotated[Literal["OTHER"], PropertyInfo(alias="mediaType")]]
