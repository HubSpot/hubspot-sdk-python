...
__all__ = ["UpdateDocumentObjectRequestParam"]


class UpdateDocumentObjectRequestParam(TypedDict, total=False):
    media_type: Required[Annotated[Literal["DOCUMENT"], PropertyInfo(alias="mediaType")]]
