...
__all__ = ["MediaBridgeCreateMediaPlayedPercentEventParams"]


class MediaBridgeCreateMediaPlayedPercentEventParams(TypedDict, total=False):
    media_type: Required[
    ...
    external_play_context: Annotated[Literal["EMAIL", "EXTERNAL_PAGE"], PropertyInfo(alias="externalPlayContext")]
