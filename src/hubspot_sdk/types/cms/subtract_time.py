...
__all__ = ["SubtractTime", "StringToCheck", "Input"]

if TYPE_CHECKING or not PYDANTIC_V1:
    StringToCheck = TypeAliasType(
        "StringToCheck",
        Union[
            ConstantBoolean,
            ConstantNumber,
...
class SubtractTime(BaseModel):
    operator: Literal["SUBTRACT_TIME"]

    string_to_check: StringToCheck = FieldInfo(alias="stringToCheck")
