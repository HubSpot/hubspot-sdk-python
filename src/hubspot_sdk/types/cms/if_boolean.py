...
__all__ = ["IfBoolean", "IfExpression", "ElseExpression", "Input"]

if TYPE_CHECKING or not PYDANTIC_V1:
    IfExpression = TypeAliasType(
        "IfExpression",
        Union[
            ConstantBoolean,
            ConstantNumber,
...
if TYPE_CHECKING or not PYDANTIC_V1:
    ...
    ElseExpression: TypeAlias = Union[
        ConstantBoolean,
        ConstantNumber,
        ConstantString,
        BooleanPropertyVariable,
...
class IfBoolean(BaseModel):
    ...
    if_expression: IfExpression = FieldInfo(alias="ifExpression")

    operator: Literal["IF_BOOLEAN"]

    else_expression: Optional[ElseExpression] = FieldInfo(alias="elseExpression", default=None)
