...
class ContentSearchResult(BaseModel):
    ...
    author_full_name: Optional[str] = FieldInfo(alias="authorFullName", default=None)
    """Name of the author."""
    ...
    The content will be determined by the value of `length` in the request.
    """

    featured_image_url: Optional[str] = FieldInfo(alias="featuredImageUrl", default=None)
    """URL of the featured image."""

    in_beta: Optional[bool] = FieldInfo(alias="inBeta", default=None)
    ...
    published_date: Optional[int] = FieldInfo(alias="publishedDate", default=None)
    """The date the content was published."""

    row_id: Optional[int] = FieldInfo(alias="rowId", default=None)
    """If a dynamic page, the row ID in the HubDB table."""

    subcategory: Optional[str] = None
    """For knowledge articles, the subcategory of the article."""

    table_id: Optional[int] = FieldInfo(alias="tableId", default=None)
