...
from .collection_response_with_total_external_link_metadata import (
    CollectionResponseWithTotalExternalLinkMetadata as CollectionResponseWithTotalExternalLinkMetadata,
)
