...
EventAnchor: TypeAlias = Union[APIContactPropertyAnchor, APIStaticDateAnchor]
...
class APIContactFlow(BaseModel):
    id: str
    ...
    can_enroll_from_salesforce: bool = FieldInfo(alias="canEnrollFromSalesforce")
    ...
    suppression_list_ids: List[int] = FieldInfo(alias="suppressionListIds")
    ...
    event_anchor: Optional[EventAnchor] = FieldInfo(alias="eventAnchor", default=None)

    goal_filter_branch: Optional[GoalFilterBranch] = FieldInfo(alias="goalFilterBranch", default=None)

    name: Optional[str] = None

    start_action_id: Optional[str] = FieldInfo(alias="startActionId", default=None)

    un_enrollment_setting: Optional[APIUnEnrollmentSetting] = FieldInfo(alias="unEnrollmentSetting", default=None)
