...
__all__ = ["MarketingEventUpsertByExternalEventIDParams"]


class MarketingEventUpsertByExternalEventIDParams(TypedDict, total=False):
    ...
    body_external_event_id: Required[Annotated[str, PropertyInfo(alias="externalEventId")]]
