...
class PropertyValueParam(TypedDict, total=False):
    ...
    data_sensitivity: Annotated[Literal["none", "standard", "high"], PropertyInfo(alias="dataSensitivity")]
    """
    The sensitivity level of the property, such as "non_sensitive", "sensitive", and
    "highly_sensitive".
    """

    is_encrypted: Annotated[bool, PropertyInfo(alias="isEncrypted")]
    """Whether the property value is encrypted."""

    is_large_value: Annotated[bool, PropertyInfo(alias="isLargeValue")]

    persistence_timestamp: Annotated[int, PropertyInfo(alias="persistenceTimestamp")]

    request_id: Annotated[str, PropertyInfo(alias="requestId")]
    """A unique ID associated with this request."""

    selected_by_user: Annotated[bool, PropertyInfo(alias="selectedByUser")]
    """Whether the value was selected by a user."""

    selected_by_user_timestamp: Annotated[int, PropertyInfo(alias="selectedByUserTimestamp")]
    ...
    source_label: Annotated[str, PropertyInfo(alias="sourceLabel")]
    """A human-readable label."""

    source_metadata: Annotated[str, PropertyInfo(alias="sourceMetadata")]
    """Source metadata encoded as a base64 string. For example: `ZXhhbXBsZSBzdHJpbmc=`"""

    source_vid: Annotated[Iterable[int], PropertyInfo(alias="sourceVid")]
    ...
    use_timestamp_as_persistence_timestamp: Annotated[bool, PropertyInfo(alias="useTimestampAsPersistenceTimestamp")]
