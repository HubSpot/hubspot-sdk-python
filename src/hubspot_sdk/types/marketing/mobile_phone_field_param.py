...
from .phone_field_validation_param import PhoneFieldValidationParam

__all__ = ["MobilePhoneFieldParam"]
...
class MobilePhoneFieldParam(TypedDict, total=False):
    ...
    field_type: Required[Annotated[Literal["mobile_phone"], PropertyInfo(alias="fieldType")]]
    ...
    validation: Required[PhoneFieldValidationParam]
