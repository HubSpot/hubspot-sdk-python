...
__all__ = ["FileAssetImportFromURLAsyncParams"]


class FileAssetImportFromURLAsyncParams(TypedDict, total=False):
    access: Required[
        Literal[
            "HIDDEN_INDEXABLE",
    ...
    duplicate_validation_scope: Required[
        Annotated[Literal["ENTIRE_PORTAL", "EXACT_FOLDER"], PropertyInfo(alias="duplicateValidationScope")]
    ]
    ...
    duplicate_validation_strategy: Required[
        Annotated[Literal["NONE", "REJECT", "RETURN_EXISTING"], PropertyInfo(alias="duplicateValidationStrategy")]
    ]
