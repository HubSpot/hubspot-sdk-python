...
class FileSearchParams(TypedDict, total=False):
    ...
    If 'true' will show only public files; if 'false' will show only private files
    """

    before: str
    """Search files updated before this timestamp.

    Time must be epoch time in milliseconds.
    """

    created_at: Annotated[Union[str, datetime], PropertyInfo(alias="createdAt", format="iso8601")]
    """Search files by exact time of creation.
    ...
    """Search files by exact time of latest updated.
