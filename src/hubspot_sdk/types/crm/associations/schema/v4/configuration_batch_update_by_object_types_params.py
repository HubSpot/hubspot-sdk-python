...
__all__ = ["ConfigurationBatchUpdateByObjectTypesParams"]


class ConfigurationBatchUpdateByObjectTypesParams(TypedDict, total=False):
    from_object_type: Required[Annotated[str, PropertyInfo(alias="fromObjectType")]]

    inputs: Required[Iterable[PublicAssociationDefinitionConfigurationUpdateRequestParam]]
