...
__all__ = ["BatchBatchAssociateDefaultParams"]


class BatchBatchAssociateDefaultParams(TypedDict, total=False):
    from_object_type: Required[Annotated[str, PropertyInfo(alias="fromObjectType")]]

    inputs: Required[Iterable[PublicDefaultAssociationMultiPostParam]]
