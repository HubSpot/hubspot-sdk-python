...
class PublicAssociationFilterBranchParam(TypedDict, total=False):
    ...
    filter_branch_type: Required[Annotated[Literal["ASSOCIATION"], PropertyInfo(alias="filterBranchType")]]
