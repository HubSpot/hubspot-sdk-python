...
__all__ = ["PropertiesValidationUpdateByObjectTypeIDPropertyNameAndRuleTypeParams"]


class PropertiesValidationUpdateByObjectTypeIDPropertyNameAndRuleTypeParams(TypedDict, total=False):
    ...
    should_apply_normalization: Annotated[bool, PropertyInfo(alias="shouldApplyNormalization")]
